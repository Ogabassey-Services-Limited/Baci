...
content = content.replace(/colorScheme === 'dark' \? 'rgba\(255,255,255,0\.1\)' : 'rgba\(0,0,0,0\.2\)'/g, "colors.border");
...
content = content.replace(/colorScheme === 'dark' \? colors.success : colors.success/g, "colors.success");
content = content.replace(/colorScheme === 'dark' \? colors.warning : colors.warning/g, "colors.warning");
content = content.replace(/colorScheme === 'dark' \? colors.background : colors.background/g, "colors.background");
