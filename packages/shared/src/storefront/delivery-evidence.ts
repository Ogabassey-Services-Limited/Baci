...
>;
export type StorefrontDeliveryDailyEvidenceWithoutHash = Omit<
  StorefrontDeliveryDailyEvidence,
  'sha256'
>;
...
/** Deterministic SHA-256 for sealed evidence usable by browser and Node tooling. */
export function calculateCanonicalSha256(value: string) {
...
export function calculateStorefrontDeliveryDailyEvidenceSha256(
