...
export const WEB_PRODUCT_WITH_VARIANTS_QUERY_PUBLIC = `${WEB_PRODUCT_COLUMNS_PUBLIC}, variants:product_variants!product_variants_product_id_fkey(${WEB_PRODUCT_VARIANT_COLUMNS})`;
