...
describe('event pipeline service authority graph', () => {
  ...
  it.each([['shadowing parameter', "import { createServiceClient } from '@/lib/supabase/service';", "import { createServiceClient } from '@/lib/supabase/service'; function safe(createServiceClient) { createServiceClient(); } safe(() => null);"], ['later safe helper call', "import { createServiceClient } from '@/lib/supabase/service'; function invoke(factory) { factory('event-pipeline'); } invoke(createServiceClient);", "import { createServiceClient } from '@/lib/supabase/service'; function invoke(factory) { factory('event-pipeline'); } invoke(createServiceClient); invoke(() => null);"], ['safe reassignment', "import { createServiceClient } from '@/lib/supabase/service';", "import { createServiceClient } from '@/lib/supabase/service'; let make = createServiceClient; make = safe; make('event-pipeline');"], ['safe object member', "import { createServiceClient } from '@/lib/supabase/service';", "import { createServiceClient } from '@/lib/supabase/service'; const safe = () => null; const bag = { make: createServiceClient, safe }; bag.safe('event-pipeline');"], ['safe helper member', "import { createServiceClient } from '@/lib/supabase/service';", "import { createServiceClient } from '@/lib/supabase/service'; function invoke(factory) { factory('event-pipeline'); } function safe(factory) { return factory; } const helpers = { invoke, safe }; helpers.safe(createServiceClient);"], ['shadowed require owner', "import { createServiceClient } from '@/lib/supabase/service';", "import { createServiceClient } from '@/lib/supabase/service'; function safe(require) { const owner = require('@/lib/supabase/service'); owner.createServiceClient('event-pipeline'); } safe(() => ({ createServiceClient: () => null }));"], ['safe comma result', "import { createServiceClient } from '@/lib/supabase/service';", "import { createServiceClient } from '@/lib/supabase/service'; const safe = () => null; (createServiceClient, safe)('event-pipeline');"], ['shadowing class', "import { createServiceClient } from '@/lib/supabase/service';", "import { createServiceClient } from '@/lib/supabase/service'; { class createServiceClient {} new createServiceClient(); }"]])('does not report a new construction for %s', (_, frozenSource, currentSource) => { const path = 'apps/web/src/lib/events/inherited-service-importer.ts'; const service = 'apps/web/src/lib/supabase/service.ts'; const frozen = new Map([[path, frozenSource], [service, 'export const createServiceClient = () => null;']]); const current = new Map(frozen); current.set(path, currentSource); expect(serviceAuthorityGraphFindings(current, [path], frozen)).toEqual([]); });
