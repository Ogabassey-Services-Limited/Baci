...
setDefaultEnv('OGABASSEY_CWV_TARGET_LABELS', 'pdp-lcp');
setDefaultEnv(
  'OGABASSEY_PDP_LCP_URL',
  'https://ogabassey.com/laptops/lenovo-legion-pro-9-16irx9-rtx-4090'
);
setDefaultEnv('OGABASSEY_CWV_USE_PDP_LCP_URL', '1');
setDefaultEnv('OGABASSEY_CWV_RESOLVE_PDP_CANONICAL', '1');
setDefaultEnv('OGABASSEY_CWV_SKIP_LATEST_BLOG_POST', '1');
setDefaultEnv('OGABASSEY_CWV_PSI', '0');
setDefaultEnv('OGABASSEY_CWV_DEBUGBEAR', '1');
setDefaultEnv('OGABASSEY_CWV_SUMMARY_TABLE', '0');
setDefaultEnv('OGABASSEY_CWV_LEGACY_PDP_LCP_JSON', '1');
