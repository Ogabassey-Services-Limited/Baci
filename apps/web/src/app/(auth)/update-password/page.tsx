            ...
            <div className="flex min-h-screen flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-zinc-900">
                <div className="w-full max-w-md space-y-8 bg-white dark:bg-zinc-800 p-10 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-700 text-center">
                    <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-green-100 dark:bg-green-900/30 mb-6">
                        <svg className="h-10 w-10 text-green-600 dark:text-green-500" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true">
                    ...
                    <div className="mt-8">
                        <Link href="/login" className="text-sm font-semibold text-[#23255d] dark:text-yellow-500 hover:text-opacity-80">
                            Go to Login &rarr;
                        </Link>
                    </div>
                </div>
        ...
        <div className="flex min-h-screen flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-zinc-900">
            <div className="w-full max-w-md space-y-8 bg-white dark:bg-zinc-800 p-10 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-700">
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Baci</h1>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleUpdate}>
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={loading}
                            className="group relative flex w-full justify-center rounded-md bg-[#23255d] px-3 py-3 text-sm font-semibold text-white hover:bg-opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#23255d] disabled:opacity-70 transition-all shadow-md"
                        >
