...
export function ProductIndexCard({
  ...
  return (
    <article className="overflow-hidden rounded-3xl border border-store-background-text/10 bg-store-background shadow-sm transition-shadow hover:shadow-lg">
      <Link
      ...
      >
        ...
        <div className="space-y-3 p-4">
          <div className="space-y-1">
            ...
            <h2 className="line-clamp-2 text-base font-semibold text-store-background-text">
              {product.name}
            </h2>
          </div>

          <div className="flex items-center justify-between gap-3">
            <p className="text-sm font-semibold text-store-background-text">
              {formattedPrice}
            </p>
