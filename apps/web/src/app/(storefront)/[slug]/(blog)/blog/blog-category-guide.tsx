...
function getOgabasseyCategoryGuideCopy(
  ...
  const categoryAliases: Record<string, string> = {
    'deals-and': 'deals',
    'news-and': 'news',
    'platform-comparisons-and': 'platform-comparisons',
    'product-guides-and': 'product-guides',
    'review-and': 'review',
    'smartphone-comparisons-and': 'smartphone-comparisons',
  };
    ...
    >
      ...
      <ul className="mt-4 grid gap-2 text-sm text-muted-foreground md:grid-cols-3">
        {guide.bullets.map((bullet) => (
          <li key={bullet} className="rounded-xl bg-muted/50 px-3 py-2">
            {bullet}
          </li>
        ))}
      </ul>
