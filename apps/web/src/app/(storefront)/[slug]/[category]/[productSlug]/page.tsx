...
export async function generateMetadata({
  ...
  const fallbackBusinessName = merchant?.business_name || 'Baci Store';
  ...
  const seoDescription = generateMetaDescription(
    ...
    {
      minLength: 110,
      fallback: `Buy ${product.name} from ${fallbackBusinessName}. Shop trusted ${productCategoryName} with fast nationwide delivery and flexible payment options.`,
    }
  );
