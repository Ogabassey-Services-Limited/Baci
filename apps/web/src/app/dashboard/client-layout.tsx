...
export default function DashboardClientLayout({
  ...
  const unfilledPagesCount = (() => {
    // If merchant is loading or data is missing, don't show the alert yet
    if (merchantLoading || !merchant || Array.isArray(merchant) || !merchant.pages) return 0;

    const pages = merchant.pages as Record<string, string>;
    // Check if pages are actually empty strings or missing
