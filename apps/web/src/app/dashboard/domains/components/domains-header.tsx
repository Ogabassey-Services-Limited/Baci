...
export function DomainsHeader() {
  return (
    <div className="relative overflow-hidden rounded-xl bg-linear-to-r from-slate-50 via-white to-slate-50 dark:from-slate-900/50 dark:via-slate-800/30 dark:to-slate-900/50 border p-6 shadow-sm">
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 size-32 bg-linear-to-bl from-primary/10 to-transparent rounded-full blur-2xl" />
      <div className="absolute bottom-0 left-0 size-24 bg-linear-to-tr from-purple-500/10 to-transparent rounded-full blur-xl" />
