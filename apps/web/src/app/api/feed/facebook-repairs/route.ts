...
import { generateRepairsFacebookFeedForIdentifier } from './feed-service';

/**
 * Facebook & Instagram repairs catalog feed API.
 *
 * Generates a Meta-compatible XML feed, one item per active repair quote,
 * mirroring `/api/feed/facebook` (the product feed).
 *
 * Usage: /api/feed/facebook-repairs?merchant_id=xxx
 * or: /api/feed/facebook-repairs?merchant_slug=xxx
 */
