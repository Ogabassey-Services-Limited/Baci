...
describe('Wallet API CSRF Protection', () => {
  ...
  describe('PATCH /api/wallet', () => {
    it('should call checkCsrfProtection', async () => {
      ...
      // Call the handler
      // Note: We cast to any because the handler might expect Request but we pass NextRequest
      // which is compatible but might trigger TS issues in strict checks if types mismatch
  ...
  describe('POST /api/wallet/withdraw', () => {
    it('should call checkCsrfProtection', async () => {
      ...
      // Call the handler
      await POST_WITHDRAW(request as any);
