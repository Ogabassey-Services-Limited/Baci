...
export async function POST(request: Request) {
  try {
    ...
    if (verifyError || !authData.user) {
      console.error('OTP verification error:', String(verifyError).replace(/[\r\n]/g, ' '));
    ...
    if (customerError) {
      console.error('Customer upsert error:', String(customerError).replace(/[\r\n]/g, ' '));
    ...
    console.error('Verify code error:', String(error).replace(/[\r\n]/g, ' '));
    return NextResponse.json(
