...
import { PriceRangeProducts } from './price-range-products';
...
describe('PriceRangeProducts', () => {
  ...
  it('waits for viewport activation before fetching the price-range carousel', async () => {
    ...
    render(<PriceRangeProducts product={product} />);
