...
export function CheckoutIdentityModal({
    ...
    const [activeTab, setActiveTab] = useState<'signin' | 'new'>('new');
            ...
            <DialogContent className="sm:max-w-[450px] p-0 overflow-hidden border-none rounded-2xl">
                ...
                <div className="p-6">
                    ...
                    >
                        ...
                        <TabsContent value="new" className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                            <div className="space-y-4">
                                <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 group hover:border-[var(--store-primary)]/30 transition-all">
                                    ...
                                    <p className="text-xs text-gray-500 mb-4">
                                        Fastest way to checkout. You can create an account after your order is placed.
                                    </p>
                                    <Button
                                ...
                                <div className="p-4 bg-[var(--store-primary)]/5 rounded-2xl border border-[var(--store-primary)]/10 text-center">
                                    <h3 className="font-bold text-gray-900 mb-1 flex items-center justify-center gap-2">
                                        <UserPlus size={16} className="text-[var(--store-primary)]" />
                                        Create Account
                                    </h3>
                                    ...
                                    <Button
                                        variant="outline"
                                        onClick={() => router.push('/signup?redirect=/checkout' as any)}
                        ...
                        <TabsContent value="signin" className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                            <form onSubmit={handleLogin} className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="email" className="text-xs font-bold text-gray-700 uppercase tracking-wide px-1">
                                        Email Address
                                    </Label>
                                    <Input
                                        id="email"
