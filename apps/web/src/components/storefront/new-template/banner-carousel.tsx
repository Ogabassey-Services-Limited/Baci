            ...
            {slide.type === 'image' && slide.imageUrl ? (
              <div className="w-full h-full relative overflow-hidden group">
                ...
                >
                  ...
                  <button type="button" className="mt-4 px-6 py-2 bg-white text-gray-900 text-xs md:text-sm font-bold rounded-full w-fit hover:bg-gray-100 transition-colors shadow-lg active:scale-95">
                    Shop Now
                  </button>
                </div>
              </div>
