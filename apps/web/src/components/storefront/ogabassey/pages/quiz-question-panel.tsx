...
/**
 * Renders a single quiz question with a visible per-question countdown. When
 * the countdown reaches the auto-submit lead it fires `onAutoSubmit` so a slow
 * player never silently blows the server window (FIX A). Keyed by question id
 * in the parent, so a new question remounts this panel and restarts the timer.
 */
