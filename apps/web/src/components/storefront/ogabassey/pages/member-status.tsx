      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 w-full flex-1 flex flex-col">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-2">
              <span
                className={`bg-black/20 backdrop-blur-md ${currentTier.textColor} ${currentTier.borderColor} border px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mb-2">
                      Earn 500 points for every verified purchase review with
                      photos.
                    </p>
                  </div>
                </div>
            ...
            {/* Current Benefits */}
            <h3 className="font-bold text-lg text-gray-900 mt-8 mb-4">
