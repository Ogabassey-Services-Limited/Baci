...
interface LoginSession {
  ...
  location: string;
  time: string;
  status: 'current' | 'logged_in';
}

const loginActivity: LoginSession[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    time: 'Oct 24 at 10:00 AM',
    status: 'logged_in',
  },
];

export const OgabasseyV2Security: React.FC = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-red-50 rounded-2xl p-6 border border-red-100">
              ...
              <button
                type="button"
                className="w-full border border-red-200 text-red-700 font-bold py-2.5 rounded-xl text-xs hover:bg-red-100 transition-colors"
              >
                Delete Account
              </button>
            </div>
