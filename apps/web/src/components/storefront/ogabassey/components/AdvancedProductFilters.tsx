...
// Migrated from temp-source/components/AdvancedProductFilters.tsx
import {
  Check,
  ChevronDown,
  Gamepad2,
    ...
    <section className="bg-white border-b border-gray-100 sticky top-0 z-40 shadow-sm transition-all duration-300">
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-3">
        <div className="flex flex-col lg:flex-row flex-wrap items-start lg:items-center justify-between gap-4">
          {/* Category Filter */}
          <div className="flex items-center gap-2 overflow-x-auto w-full lg:w-auto lg:flex-1 lg:min-w-0 hide-scrollbar pb-2 lg:pb-0">
                    ...
                    <div className="flex overflow-x-auto hide-scrollbar gap-2 pr-0">
                      {['All', ...brands].map((brand) => (
                        <button
                          ...
                          className={`px-3 py-1.5 text-xs font-bold rounded-md whitespace-nowrap transition-colors border shrink-0 ${selectedBrand === brand
