          ...
          {step === 'form' ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              <p className="text-sm text-gray-500 mb-4">
                Can't find what you're looking for? Tell us what it is, and
                we'll hunt it down for you.
              </p>
            ...
            <div className="text-center py-8 flex flex-col items-center animate-in fade-in slide-in-from-bottom-4">
              ...
              <p className="text-gray-500 mb-6 max-w-xs mx-auto leading-relaxed text-sm">
                We've started the search for{' '}
                <strong>{formData.productName}</strong>. We will contact you at{' '}
                <strong>{formData.contact}</strong> as soon as we locate it.
              </p>
