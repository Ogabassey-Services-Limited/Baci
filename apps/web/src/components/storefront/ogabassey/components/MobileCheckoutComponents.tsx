...
export const MobileOrderSummary: React.FC<MobileOrderSummaryProps> = ({
    ...
    const { formatCurrencyCompact, currencyCode } = useCurrency();
            ...
            <div className="max-w-[1400px] mx-auto px-4">
                ...
                >
                    ...
                    <span className="font-bold text-gray-900 text-lg">
                        {formatCurrencyCompact(remainingAmount)}
                    </span>
                </button>
                ...
                >
                            ...
                            <div key={item.cartItemId} className="flex gap-3">
                                ...
                                <div className="flex-1 min-w-0 py-1">
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">
                                        {formatCurrencyCompact(item.negotiatedPrice || item.price)}
                                    </p>
                                </div>
                            </div>
                        ))}
                    ...
                    <div className="space-y-2 text-sm">
                        <div className="flex justify-between text-gray-600">
                            <span>Subtotal</span>
                            <span>{formatCurrencyCompact(cartTotal)}</span>
                        </div>
                        <div className="flex justify-between text-gray-600">
                            <span>Delivery</span>
                    ...
                    <div className="flex justify-between text-base font-bold text-gray-900 items-baseline">
                        ...
                        <div className="text-right">
                            ...
                            <span className="text-xl">{formatCurrencyCompact(remainingAmount)}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="shrink-0">
                    ...
                    <p className="text-lg font-bold text-gray-900 leading-tight">
                        {formatCurrencyCompact(totalDisplay)}
                    </p>
                </div>
