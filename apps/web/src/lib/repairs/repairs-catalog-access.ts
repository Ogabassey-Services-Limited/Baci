...
/**
 * Resolves a storefront slug to its merchant id and whether the repairs
 * catalogue is publicly enabled (electronics/gadgets business type + flag on).
 * The catalogue RLS enforces the same gate, but the read APIs 404 early when the
 * feature is off. Returns null when the merchant does not exist.
 */
