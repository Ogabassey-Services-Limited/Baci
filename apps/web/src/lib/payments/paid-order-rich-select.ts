...
export const PAID_ORDER_RICH_SELECT =
  'id, merchant_id, order_number, customer_id, total, subtotal, shipping_fee, shipping_funding_source, shipping_platform_retained_amount, gift_wrapping_fee, tax_amount, discount_amount, tax_basis, customer_name, customer_email, customer_phone, shipping_address, currency, payment_status, shipping_status, cancelled_at, updated_at, ad_tracking, order_items(id, product_id, condition, name, price, quantity, variant_name)';
