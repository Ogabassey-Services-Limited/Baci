    ...
    try {
      ...
      `)
        ...
        const orderConversionData: OrderConversionData = {
            ...
            customerZip: order.shipping_address?.zip || order.shipping_address?.postal_code,
        ...
        const results = await sendPurchaseConversion(analyticsConfig, orderConversionData);
