...
export const JumiaPackV2ResponseSchema = z.object({
  success: z
    .object({
...
export const JumiaReadyToShipResponseSchema = z.object({
  success: z
    .object({
      packages: z.array(FulfillmentPackageSchema),
      total: z.number(),
...
export const JumiaCancelResponseSchema = z.object({
  success: z
    .object({
      orderItems: z.array(
        z.object({
...
export const JumiaPrintLabelsResponseSchema = z.object({
  success: z
    .object({
      labels: z.array(
        z.object({
