...
export type AgenticPaymentMethod =
  ...
  | typeof AGENTIC_PAYMENT_METHOD_GOOGLE_PAY;
...
const AGENTIC_PAYMENT_PROVIDER_GOOGLE_PAY = AGENTIC_PAYMENT_METHOD_GOOGLE_PAY;
...
export type AgenticPaymentProvider =
  ...
  | typeof AGENTIC_PAYMENT_PROVIDER_GOOGLE_PAY;
