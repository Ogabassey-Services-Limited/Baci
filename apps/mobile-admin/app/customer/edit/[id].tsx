...
import { SPACING, RADIUS, TYPOGRAPHY, ICON_SIZE } from '@/constants/theme';
...
export default function CustomerEditScreen() {
    ...
    useEffect(() => {
        if (customer) {
            ...
            if (!fName && !lName && (customer as any).full_name) {
                const parts = ((customer as any).full_name as string).split(' ');
                fName = parts[0];
    ...
    if (isLoading) {
        return (
            <View style={[styles.loadingContainer, { backgroundColor: colors.background }]}>
                <Stack.Screen options={{ title: 'Loading...', headerBackTitle: 'Cancel' }} />
    ...
    const getInputStyle = (fieldName: string) => [
        styles.input,
        {
            backgroundColor: focusedField === fieldName ? colors.background : colors.backgroundLight,
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['bottom']}>
            ...
            >
                ...
                >
                    ...
                    >
                        <View style={[styles.avatarOuter, { backgroundColor: colors.primaryLight }]}>
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            <PhoneInput
                                ...
                                containerStyle={[
                                    ...
                                    {
                                        backgroundColor: focusedField === 'phone' ? colors.background : colors.backgroundLight,
                    ...
                    >
                        ...
                        <View style={styles.inputGroup}>
                            <Text style={[styles.label, { color: colors.textSecondary }]}>Shipping Address</Text>
                            <TextInput
