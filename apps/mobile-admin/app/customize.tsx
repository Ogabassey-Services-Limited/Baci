...
const PROMPT_SUGGESTIONS = [
    { icon: 'color-palette', label: 'Make it blue', prompt: 'Change the primary color to blue' },
    { icon: 'add-circle', label: 'Add testimonials', prompt: 'Add a testimonials section with customer reviews' },
    { icon: 'sparkles', label: 'Make it festive', prompt: 'Add festive red and gold colors for the holiday season' },
    { icon: 'text', label: 'Update hero text', prompt: 'Change the hero title to "Welcome to our store"' },
];
        ...
        <View
            style={[
                ...
                isUser
                    ...
                    : isSystem
                        ? [styles.systemBubble, { backgroundColor: colors.errorLight || '#FEE2E2' }]
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['bottom']}>
            ...
            <View style={[styles.toggleContainer, { backgroundColor: colors.card }]}>
                <Pressable
                    style={[
                        styles.toggleButton,
                        viewMode === 'chat' && [styles.toggleActive, { backgroundColor: colors.primary }],
                    ]}
                ...
                <Pressable
                    style={[
                        styles.toggleButton,
                        viewMode === 'preview' && [styles.toggleActive, { backgroundColor: colors.primary }],
                    ]}
            ...
            {viewMode === 'chat' ? (
                ...
                >
                    ...
                    {messages.length === 0 ? (
                        <View style={styles.welcomeContainer}>
                            ...
                            <Text style={[styles.welcomeSubtitle, { color: colors.textSecondary }]}>
                                Tell me how you'd like to customize your store. I can change colors, add sections,
                                update content, and more!
                            </Text>
                    ...
                    {/* Input */}
                    <View style={[styles.inputContainer, { backgroundColor: colors.card }, shadows.md]}>
                        <TextInput
