                        ...
                        <View style={{ flexDirection: 'row', gap: SPACING.sm }}>
                            ...
                            >
                                <Ionicons
                                    name="trash-outline"
                                    size={22}
                                    color={deleteCustomer.isPending ? colors.textMuted : colors.error}
                                />
                            </Pressable>
                            <Pressable
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={[styles.card, { backgroundColor: colors.card }, shadows.sm]}>
                    <View style={styles.headerProfile}>
                        <View style={[styles.avatarLarge, { backgroundColor: colors.goldLight }]}>
                    ...
                    <View style={styles.contactRow}>
                        <View style={styles.contactItem}>
                            ...
                            <Text style={[styles.contactValue, { color: colors.text }]}>{customer.email}</Text>
                        </View>
                        <Pressable
                    ...
                    {customer.phone && (
                        <View style={styles.contactRow}>
                            <View style={styles.contactItem}>
                                ...
                                <Text style={[styles.contactValue, { color: colors.text }]}>{customer.phone}</Text>
                            </View>
                    ...
                    {customer.address && (
                        <View style={styles.contactRow}>
                            <View style={styles.contactItem}>
                                ...
                                <Text style={[styles.contactValue, { color: colors.text }]}>{customer.address}</Text>
                            </View>
                        </View>
                    )}
                </View>
                ...
                <View style={styles.statsGrid}>
                    <View style={[styles.statCard, { backgroundColor: colors.card }, shadows.sm]}>
                        ...
                        <Text style={[styles.statValue, { color: colors.text }]}>{customer.total_orders}</Text>
              ...
              Let's show loyalty or credit if they exist, else verify interface */}
                ...
                {customer.recent_orders && customer.recent_orders.length > 0 ? (
                    <View style={styles.ordersList}>
                        {customer.recent_orders.map((order: any) => (
                            ...
                            >
                                <View style={[
                                    styles.orderIcon,
                                    { backgroundColor: order.shipping_status === 'delivered' ? '#DCFCE7' : colors.background }
                                ]}>
                                    <Ionicons
                                        name="cube-outline"
                                        size={20}
                                        color={order.shipping_status === 'delivered' ? '#16A34A' : colors.textMuted}
                                    />
                                </View>
                    ...
                    <View style={[styles.emptyState, { backgroundColor: colors.card }]}>
                        <Text style={[styles.emptyStateText, { color: colors.textSecondary }]}>No recent orders</Text>
                    </View>
                )}
