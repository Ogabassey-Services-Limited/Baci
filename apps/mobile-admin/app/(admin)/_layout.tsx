...
export default function AdminLayout() {
    ...
    return (
        ...
        >
            ...
            <Stack.Screen name="order/[id]" options={{ title: 'Order Details', presentation: 'card' }} />
            <Stack.Screen name="product/[id]" options={{ title: 'Edit Product', presentation: 'card' }} />
            <Stack.Screen name="scan" options={{ title: 'Scan Barcode', presentation: 'modal' }} />
            <Stack.Screen name="domains" options={{ headerShown: false, presentation: 'card' }} />
      ...
      */}
            ...
            <Stack.Screen name="payout-settings" options={{ title: 'Payout Settings' }} />
            <Stack.Screen name="profile" options={{ title: 'Profile' }} />
            <Stack.Screen name="send-feedback" options={{ title: 'Send Feedback' }} />
            <Stack.Screen name="setup-checklist" options={{ title: 'Setup Checklist' }} />
