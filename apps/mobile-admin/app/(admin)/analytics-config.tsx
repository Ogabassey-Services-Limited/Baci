                ...
                <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                    ...
                    <View style={[styles.card, { backgroundColor: colors.card }, shadows.sm]}>
                        <View style={styles.cardHeader}>
                            <Ionicons name="bar-chart" size={24} color={colors.primary} style={styles.cardIcon} />
                            <Text style={[styles.sectionTitle, { color: colors.text }]}>Tracking Codes</Text>
                        </View>
                        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
                            Add your pixel and tracking IDs to track visitors and conversion events.
                        </Text>

                        {/* Google Analytics */}
                        <View style={styles.inputGroup}>
                            <Text style={[styles.label, { color: colors.textSecondary }]}>Google Analytics ID (G-XXXX)</Text>
                            <View style={[styles.inputContainer, { borderColor: colors.border, backgroundColor: colors.background }]}>
                                <Ionicons name="logo-google" size={20} color={colors.textMuted} />
                                <TextInput
                                    style={[styles.input, { color: colors.text }]}
                                    value={analytics.google}
                                    onChangeText={(t) => setAnalytics(p => ({ ...p, google: t }))}
                        ...
                        {/* Meta Pixel */}
                        <View style={styles.inputGroup}>
                            <Text style={[styles.label, { color: colors.textSecondary }]}>Meta Pixel ID</Text>
                            <View style={[styles.inputContainer, { borderColor: colors.border, backgroundColor: colors.background }]}>
                        ...
                        {/* TikTok Pixel */}
                        <View style={styles.inputGroup}>
                            <Text style={[styles.label, { color: colors.textSecondary }]}>TikTok Pixel ID</Text>
                            <View style={[styles.inputContainer, { borderColor: colors.border, backgroundColor: colors.background }]}>
                                <Ionicons name="logo-tiktok" size={20} color={colors.textMuted} />
                                <TextInput
                                    style={[styles.input, { color: colors.text }]}
                                    value={analytics.tiktok}
                                    onChangeText={(t) => setAnalytics(p => ({ ...p, tiktok: t }))}
