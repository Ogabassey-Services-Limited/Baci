...
import Colors, { BRAND, SPACING, RADIUS, SHADOWS, palette } from '@/constants/Colors';
    ...
    const renderItem = ({ item }: { item: NegotiationRequest }) => (
        <View style={styles.card}>
            <View style={styles.cardHeader}>
                <View style={[
                    styles.typeBadge,
                    { backgroundColor: item.type === 'total' ? palette.amber[100] : palette.red[50] }
                ]}>
                    <Text style={[
                        styles.typeText,
                        { color: item.type === 'total' ? palette.amber[700] : palette.red[700] }
                    ]}>
            ...
            {item.evidence_url && (
                <Pressable
                    ...
                    onPress={() => Alert.alert('Evidence', 'Evidence image viewing pending implementation')}
                >
                    <Ionicons name="image-outline" size={16} color={palette.blue?.[500] || '#3B82F6'} />
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        <Ionicons name="chatbubbles-outline" size={64} color={palette.gray[200]} />
                        <Text style={styles.emptyTitle}>No Pending Negotiations</Text>
                        <Text style={styles.emptySubtitle}>All quiet for now. New requests will appear here instantly.</Text>
                    </View>
                }
            />
        </View>
