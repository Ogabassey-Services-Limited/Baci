    ...
    const renderExpenseItem = ({ item }: { item: Expense }) => (
        ...
        >
            ...
            <View style={styles.expenseAmount}>
                ...
                {item.receipt_url && (
                    <Ionicons name="document-attach-outline" size={14} color={colors.textSecondary} style={{ marginTop: 4 }} />
                )}
            </View>
        </Pressable>
    );
        ...
        <>
            <Stack.Screen
                options={{
                    ...
                    headerRight: () => (
                        <Pressable onPress={() => router.push('/expenses/new')} style={styles.headerButton}>
                    ...
                    <FlatList
                        ...
                        ListEmptyComponent={
                            <View style={styles.emptyContainer}>
                                ...
                                >
                                    <Text style={[styles.emptyButtonText, { color: colors.primary }]}>Add your first expense</Text>
                                </Pressable>
                            </View>
                        }
                    />
...
const styles = StyleSheet.create({
    ...
    summaryTrendText: { color: '#ffffffcc', fontSize: TYPOGRAPHY.size.xs, fontFamily: TYPOGRAPHY.fontFamily.medium },
    ...
    expenseCategory: { fontSize: TYPOGRAPHY.size.md, fontFamily: TYPOGRAPHY.fontFamily.semiBold, marginBottom: 2 },
    expenseDescription: { fontSize: TYPOGRAPHY.size.sm, fontFamily: TYPOGRAPHY.fontFamily.regular, marginBottom: 2 },
    expenseDate: { fontSize: TYPOGRAPHY.size.xs, fontFamily: TYPOGRAPHY.fontFamily.medium },
    expenseAmount: { alignItems: 'flex-end' },
    amountText: { fontSize: TYPOGRAPHY.size.md, fontFamily: TYPOGRAPHY.fontFamily.bold },
    ...
    emptyContainer: { alignItems: 'center', justifyContent: 'center', padding: SPACING['3xl'], marginTop: SPACING.xl },
    emptyText: { marginTop: SPACING.md, fontSize: TYPOGRAPHY.size.md, fontFamily: TYPOGRAPHY.fontFamily.medium, textAlign: 'center' },
    emptyButton: { marginTop: SPACING.lg, paddingVertical: SPACING.sm, paddingHorizontal: SPACING.lg, borderRadius: RADIUS.full, borderWidth: 1 },
    emptyButtonText: { fontSize: TYPOGRAPHY.size.sm, fontFamily: TYPOGRAPHY.fontFamily.semiBold },
});
