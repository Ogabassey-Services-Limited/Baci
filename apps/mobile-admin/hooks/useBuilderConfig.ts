...
const WEB_API_BASE = process.env.EXPO_PUBLIC_WEB_API_URL || 'https://usebaci.com';
...
export function useBuilderConfig(pageSlug: string = 'home') {
    ...
    const [currentConfig, setCurrentConfig] = useState<BuilderConfig | null>(null);
    ...
    return {
        ...
        // Convenience
        hasUnsavedChanges: !!currentConfig && JSON.stringify(currentConfig) !== JSON.stringify(configData?.config),
