            ...
            <body>
                ...
                <table>
                    ...
                    <tbody>
                         <tr>
                            <td>Top Product</td>
                            <td class="bold">${data.topProduct?.name || 'N/A'}</td>
                            <td class="right">${formatCurrency(data.topProduct?.revenue || 0)}</td>
                        </tr>
                        <tr>
                            <td>Top Vendor</td>
                            <td class="bold">${data.topBrand?.name || 'N/A'}</td>
                            <td class="right">${formatCurrency(data.topBrand?.revenue || 0)}</td>
                        </tr>
                         <tr>
                            <td>Top Customer</td>
                            <td class="bold">${data.topCustomer?.name || 'N/A'}</td>
    ...
    .map(
      (tx) => `
        <tr>
            ...
            <td>${tx.customer?.first_name || 'Guest'}</td>
            <td class="right">${formatCurrency(tx.total_amount - (tx.tax_amount || 0))}</td>
