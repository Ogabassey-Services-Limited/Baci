/**
 * ROLLBACK BACKUP - Created 2026-02-03
 *
 * To restore this file:
 * 1. Delete all new files in components/checkout/checkout-identity/
 * 2. Copy this file's content back to CheckoutIdentityModal.tsx
 *
 * Or use git:
