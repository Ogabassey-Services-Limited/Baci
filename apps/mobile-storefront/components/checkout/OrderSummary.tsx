...
import { BRAND, SPACING, RADIUS, palette } from '@/constants/Colors';
import { formatPrice, type CartItem } from '@/stores/cart-store';
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.summaryRow}>
                        ...
                        <Text style={[styles.summaryValue, { color: deliveryFee === 0 ? colors.success : colors.text }]}>
                            {deliveryFee === 0 ? 'Calculated at next step' : formatPrice(deliveryFee)}
                        </Text>
                    </View>
