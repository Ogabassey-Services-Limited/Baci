...
export type WebIconName = 'Shirt' | 'Laptop' | 'Home' | 'Sparks' | 'Palette' | 'CoffeeCup' | 'Scissor' | 'Pill' | 'Sparkles';
 ...
 */
export function getCategoryIcon(identifier: string): keyof typeof Ionicons.glyphMap {
