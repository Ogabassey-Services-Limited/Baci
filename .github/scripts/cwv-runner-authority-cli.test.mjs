...
const checkedSources = Object.fromEntries([
  ...
  '.github/scripts/cwv-runner-authority.mjs',
  '.github/scripts/cwv-runner-authority-core.mjs',
  '.github/scripts/cwv-runner-authority-runtime.mjs',
  '.github/scripts/cwv-runner-stable-attestation-builder.mjs',
...
const policy = { artifactRetentionDays: 90, repository: { id: 1100488586, name: 'ogabasseyy/Baci' }, runner: { name: 'baci-cwv-measurement-01', labels: ['self-hosted', 'Linux', 'X64', 'baci-cwv-measurement'] }, workflowActions: pins, ruleset: { name: 'ogabassey-rollout-progress-immutable', target: 'tag', enforcement: 'active', tagIncludes: ['refs/tags/ogabassey-rollout-claim/*', 'refs/tags/ogabassey-rollout-progress/**/*', 'refs/tags/ogabassey-semantic-admission/*'], tagExcludes: [], rules: ['update', 'deletion'], bypassActors: [] }, thresholds: { load1Max: 0.5, networkSampleSeconds: 10 } };
class FakeFs {
...
const raw = JSON.stringify(policy); const rawDigest = createHash('sha256').update(raw).digest('hex');
