...
node --test "$repo_root/supabase/tests/serialized_variant_inventory_concurrency_contract_sold_release.test.mjs"
...
bash "$repo_root/supabase/tests/run-serialized-variant-inventory-concurrency-test.sh"
