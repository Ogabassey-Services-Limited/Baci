...
is_postdeploy_migration() {
  case "$1" in
    20260827140000_enforce_storefront_order_delivery_metadata|20260828091000_harden_storefront_order_rpc_context_and_replays|20260828101000_allow_legacy_quiz_award_order_context|20260828110000_prepare_storefront_order_hash_stamping|20260828110100_finalize_storefront_order_hash_stamping|20260828120000_enforce_storefront_order_replay_route_context|20260828130000_scope_storefront_order_replay_route_context|20260828151000_enforce_storefront_airport_pickup_location|20260828160000_persist_quiz_reserved_order_delivery_metadata|20260828160100_preserve_quiz_reserved_order_delivery_metadata)
      return 0
      ;;
    *)
      return 1
