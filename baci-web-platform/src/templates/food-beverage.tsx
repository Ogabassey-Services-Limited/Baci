...
export function FoodBeverageHome(props: TemplatePageProps) {
    ...
    return (
        <div className="min-h-screen bg-[#FFF8E7]">
            ...
            <section className="relative bg-gradient-to-br from-[#D2691E] to-[#8B4513] text-white overflow-hidden">
                {/* Decorative pattern */}
                    ...
                    <div className="max-w-3xl">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div className="flex gap-2">
                                <span className="px-3 py-1 bg-[#556B2F] text-white text-xs font-semibold rounded-full">
                                    Farm Fresh
                                </span>
                        ...
                        <h1 className="text-5xl md:text-6xl font-serif font-bold mb-6 leading-tight">
                            ...
                            <span className="text-[#FFE4B5]">Delivered Fresh</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <button
                                ...
                                className="px-8 py-4 bg-white text-[#8B4513] rounded-full font-semibold hover:bg-orange-50 transition-colors shadow-lg"
                            >
                                Shop Fresh
                            </button>
                            <button className="px-8 py-4 bg-[#556B2F] text-white rounded-full font-semibold hover:bg-[#4A5D28] transition-colors shadow-lg flex items-center gap-2">
                            ...
                            return (
                                <div key={index} className="flex items-center gap-3">
                                    <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0">
                                        <Icon className="w-6 h-6 text-[#D2691E]" />
                                    </div>
                                    <div>
                                        <div className="font-semibold text-[#3D2314] text-sm">{badge.title}</div>
            ...
            {/* Category Navigation */}
            <section className="py-12 bg-[#FFF8E7]">
                <div className="max-w-7xl mx-auto px-6">
                    <h2 className="text-3xl font-serif font-bold text-center text-[#3D2314] mb-8">
                        Shop by Category
                    </h2>
                            ...
                            return (
                                <button
                                    ...
                                    className={`p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 ${isActive
                                            ? 'border-[#D2691E] bg-orange-50 shadow-md'
                                            : 'border-orange-200 bg-white hover:border-[#D2691E] hover:shadow-sm'
                                        }`}
                                >
                                    <Icon className={`w-8 h-8 ${isActive ? 'text-[#D2691E]' : 'text-gray-400'}`} />
                                    <span className={`text-sm font-medium ${isActive ? 'text-[#D2691E]' : 'text-gray-700'}`}>
                                        {category.name}
                                    </span>
                                </button>
                            );
            ...
            >
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-8">
                        <h2 className="text-4xl font-serif font-bold text-[#3D2314] mb-4">
                    ...
                    <div className="mb-8">
                        <div className="bg-gradient-to-r from-orange-50 to-lime-50 border border-orange-200 rounded-2xl p-4 shadow-sm">
                            <div className="flex items-center justify-center gap-2 flex-wrap">
                                <span className="text-sm font-medium text-[#3D2314] mr-2">Dietary:</span>
            ...
            <section className="py-16 bg-gradient-to-r from-[#556B2F] to-[#3D5A1B] text-white">
                <div className="max-w-7xl mx-auto px-6">
                            ...
                            <ul className="space-y-3 mb-8">
                                {['Seasonal local produce', 'Artisan breads & pastries', 'Free delivery included', 'Skip or cancel anytime'].map((item, idx) => (
                                    <li key={idx} className="flex items-center gap-3">
                                        <div className="w-5 h-5 bg-lime-400 text-[#3D5A1B] rounded-full flex items-center justify-center text-xs font-bold">✓</div>
                                        <span>{item}</span>
                                    </li>
                                ))}
                            </ul>
                            <button className="px-8 py-4 bg-white text-[#3D5A1B] rounded-full font-semibold hover:bg-lime-50 transition-colors shadow-lg">
                                Start Your Box →
                            </button>
                        </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {recipes.map((recipe, idx) => (
                            <div key={idx} className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-shadow group cursor-pointer">
                                ...
                                <div className="p-6">
                                    <h3 className="text-xl font-serif font-bold text-[#3D2314] mb-2">{recipe.name}</h3>
                                    <div className="flex items-center gap-4 text-sm text-gray-600">
                                        <span className="flex items-center gap-1">
                                            <Clock className="w-4 h-4" /> {recipe.time}
                                        </span>
                                        <span className="px-2 py-1 bg-orange-100 text-[#D2691E] rounded-full text-xs font-medium">
                                            {recipe.difficulty}
                                        </span>
                                    </div>
                                </div>
            ...
            <section className="py-16 bg-white border-t border-orange-200">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            <span className="text-[#D2691E] text-sm font-semibold uppercase tracking-wider">
                                Our Story
                            </span>
                            <h2 className="text-3xl font-serif font-bold text-[#3D2314] mt-2 mb-4">
                            ...
                            <button className="text-[#D2691E] font-semibold hover:text-[#8B4513] transition-colors">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        <div>
                            ...
                            <div className="flex gap-2">
                                <span className="px-2 py-1 bg-[#556B2F] text-white text-xs rounded">Organic</span>
                                <span className="px-2 py-1 bg-[#D2691E] text-white text-xs rounded">Local</span>
                            </div>
                        </div>
                        <div>
                            <h4 className="font-semibold text-white mb-4">Shop</h4>
                            <ul className="space-y-2 text-sm">
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Bakery</a></li>
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Produce</a></li>
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Dairy & Eggs</a></li>
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Beverages</a></li>
                            </ul>
                        </div>
                        <div>
                            <h4 className="font-semibold text-white mb-4">Company</h4>
                            <ul className="space-y-2 text-sm">
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Our Story</a></li>
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Our Farmers</a></li>
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Sustainability</a></li>
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Recipes</a></li>
                            </ul>
                        </div>
                        <div>
                            <h4 className="font-semibold text-white mb-4">Support</h4>
                            <ul className="space-y-2 text-sm">
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Contact Us</a></li>
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Delivery Info</a></li>
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">Returns</a></li>
                                <li><a href="#" className="hover:text-[#D2691E] transition-colors">FAQs</a></li>
                            </ul>
                        </div>
                    </div>
