...
const DEST_FILENAME = 'Apple_MacBook-Pro_14-16-inch_10182021_big.jpg.large_2x-1024x1024.avif';
...
async function upload() {
    ...
    try {
        ...
        await execAsync(`scp -o BatchMode=yes -o ConnectTimeout=5 ${LOCAL_FILE} ${REMOTE_HOST}:${tmpRemote}`);
        ...
        await execAsync(`ssh ${REMOTE_HOST} "sudo chown www-data:www-data ${TARGET_PATH}${DEST_FILENAME}"`);
