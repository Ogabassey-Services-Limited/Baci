...
const BATCH_A = [
    { id: '41ee6609-6ddb-49a6-9b65-2bee3379e41d', name: 'Dark Souls Remastered', filename: 'dark-souls-remastered.avif' },
    { id: '916b8e95-df37-4671-a211-2b7778824feb', name: 'Call of Duty Cold War', filename: 'call-of-duty-cold-war.avif' },
    { id: 'd0dc6c45-435d-4ac3-8ff4-e12b642bff5a', name: 'F1 2024', filename: 'f1-2024.avif' },
    { id: '47d518e9-2432-4fa2-96b8-63a7881c6d6f', name: 'Dirt 5', filename: 'dirt-5.avif' },
    { id: '94d7e42b-82d0-4eac-8aee-bf5b058012ec', name: 'FarCry 6', filename: 'farcry-6.avif' },
];
