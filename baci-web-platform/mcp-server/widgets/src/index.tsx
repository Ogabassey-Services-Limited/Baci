            ...
            <div className="product-actions">
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        window.openai?.openExternal?.({ href: url }) || window.open(url, '_blank');
                    }}
                >
                    Buy Now
                </button>
...
// Main App Component
function App() {
    const toolOutput = useOpenAiGlobal('toolOutput') as { products?: Product[] } | null;
    ...
    const handleViewCart = () => {
        ...
        window.openai?.openExternal?.({ href: checkoutUrl }) || window.open(checkoutUrl, '_blank');
    };
