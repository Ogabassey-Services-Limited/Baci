...
export default function ConfirmInsuranceDialog({
    ...
    const [deviceColor, setDeviceColor] = useState('Black'); // Default or extract
            ...
            if (isAssuranceOrder) {
                if (!imei || !serialNumber || !devicePhotoUrl) {
                    toast({
                        ...
                        description: 'IMEI, Serial Number, and Device Photo are required for insurance.'
                    });
                    setLoading(false);
                    return;
                }
                        ...
                        <>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="text-xs text-muted-foreground mb-2">
                                    Upload a screenshot of Settings {'>'} About Phone showing IMEI/Serial.
                                </div>
                                <FileUploader
                                    maxFiles={1}
              ...
              */}
                    ...
                    {!isAssuranceOrder && (
                        <div className="p-4 bg-muted rounded-md text-sm">
                            No additional details required for this order. Click confirm to proceed.
                        </div>
                    )}
                </div>
