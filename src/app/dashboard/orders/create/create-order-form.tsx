...
import { Loader2, PlusCircle, User, Mail, Calendar as CalendarIcon, Trash2, ChevronsUpDown } from 'lucide-react';
                    ...
                    <div className="md:col-span-2 grid gap-4">
                            ...
                            <CardContent className="grid md:grid-cols-2 gap-4">
                                ...
                                <FormField control={form.control} name="customerEmail" render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl><div className="relative"><Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" /><Input type="email" placeholder="john@example.com" {...field} className="pl-10" /></div></FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )} />
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <FormField control={form.control} name="items" render={() => (<FormItem><FormMessage className="mt-2" /></FormItem>)} />
                                ...
                                <Popover>
                                    ...
                                    <PopoverContent className="w-[--radix-popover-trigger-width] p-0" align="start">
                                        <Command>
                                            <CommandInput placeholder="Search for a product..." value={productSearch} onValueChange={setProductSearch} />
                                            <CommandList>
                                                <CommandEmpty>No products found.</CommandEmpty>
                                                <CommandGroup>
                                                    {filteredProducts.map((product) => (
                                                        <CommandItem key={product.id} onSelect={() => addProductToOrder(product)} value={product.name}>
                                                            {product.name}
                                                        </CommandItem>
                                                    ))}
                                                </CommandGroup>
