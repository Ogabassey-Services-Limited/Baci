            ...
            setReviews((prev) =>
                prev.map((r) =>
                    r.id === selectedReview.id
                        ? { ...r, merchant_response: responseText, merchant_response_at: new Date().toISOString() }
                        : r
                )
            );
                ...
                <Card>
                    <CardHeader className="pb-2">
                        ...
                        <CardTitle className="text-2xl flex items-center gap-1">
                            {stats.averageRating} <Star className="w-5 h-5 text-yellow-400 fill-yellow-400" />
                        </CardTitle>
                    </CardHeader>
                </Card>
            </div>
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            ...
                                            >
                                                ...
                                                {review.merchant_response ? 'Edit Response' : 'Add Response'}
                                            </DropdownMenuItem>
                                            <DropdownMenuSeparator />
                                            <DropdownMenuItem
            ...
            <Dialog open={showResponseDialog} onOpenChange={setShowResponseDialog}>
                <DialogContent>
                            ...
                            <div className="bg-muted/50 rounded-lg p-4">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-sm text-muted-foreground">
                                        by {selectedReview.customer_name || selectedReview.customer_email}
                                    </span>
                                </div>
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={submitResponse} disabled={isUpdating || !responseText.trim()}>
