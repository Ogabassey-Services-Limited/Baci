...
export default function AnnouncementBarPage() {
    ...
    useEffect(() => {
        if (merchant?.published_config?.announcement_bar) {
            setConfig({
                ...DEFAULT_CONFIG,
                ...(merchant.published_config.announcement_bar as Partial<AnnouncementBarConfig>),
            });
        }
    }, [merchant]);
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Display a message at the top of your store to announce sales or news.
                    </p>
                </div>
            </div>
            ...
            <div className="grid gap-6">
                ...
                <Card className="overflow-hidden">
                    <CardHeader>
                        ...
                        <CardDescription>This is how it will look on your store.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        {config.enabled ? (
                            <div
