...
export default function IntegrationsPage() {
  ...
  const [feedStatus, setFeedStatus] = useState<'valid' | 'invalid' | null>(
    null
  );
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              >
                <RefreshCw
                  className={`h-4 w-4 ${feedValidating ? 'motion-safe:animate-spin' : ''}`}
                />
              </Button>
            </div>
          </div>
        ...
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              ...
              purchase products directly on social media.
            </AlertDescription>
          </Alert>
        ...
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              ...
              shoppable ads to reach younger audiences.
            </AlertDescription>
          </Alert>
