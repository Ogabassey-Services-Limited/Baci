        ...
        <div className="min-h-screen bg-white font-sans">
            ...
            <header className="bg-[#1a1a1a] text-white py-4 px-6 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto flex items-center justify-between relative z-10 gap-4">
                    ...
                    <div className="flex items-center gap-6">
                        <button className="hover:text-red-400 transition"><Bell size={20} /></button>
                        <button className="relative hover:text-red-400 transition">
                            <ShoppingCart size={20} />
                            <span className="absolute -top-2 -right-2 bg-red-600 text-white text-[10px] w-4 h-4 flex items-center justify-center rounded-full">0</span>
                        </button>
                        <button className="hover:text-red-400 transition"><User size={20} /></button>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-7xl mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 h-auto lg:h-[500px]">
                    ...
                    <div className="lg:col-span-2 bg-gradient-to-br from-red-600 to-red-700 rounded-2xl p-8 relative overflow-hidden text-white flex flex-col justify-center items-center text-center group">
                        <div className="relative z-10">
                            <h2 className="text-4xl md:text-5xl font-bold mb-2">iPhone 16 Pro Max</h2>
                            <p className="font-handwriting text-2xl italic opacity-90">Maximize your <span className="font-bold font-serif">CREATIVITY</span></p>
                        </div>
                        {/* Placeholder for Product Image */}
                        <div className="mt-8 relative w-full h-64 flex justify-center items-end">
                            <div className="w-48 h-56 bg-gray-900 rounded-2xl shadow-2xl border-4 border-gray-700 mx-[-20px] transform -rotate-6 transition group-hover:-translate-y-2"></div>
                            <div className="w-48 h-56 bg-gray-300 rounded-2xl shadow-2xl border-4 border-white z-10 transition group-hover:-translate-y-4"></div>
                            <div className="w-48 h-56 bg-yellow-100 rounded-2xl shadow-2xl border-4 border-yellow-500 mx-[-20px] transform rotate-6 transition group-hover:-translate-y-2"></div>
                        </div>
                        {/* Carousel Dots */}
                    ...
                    <div className="bg-black text-white rounded-2xl p-6 relative overflow-hidden flex flex-col items-center">
                        <div className="text-center z-10 mt-4">
                            <p className="text-xs uppercase tracking-widest text-gray-400 mb-1">Elevate your workflow</p>
                        ...
                        {/* Placeholder Image */}
                        <div className="mt-auto w-full h-40 bg-gray-800 rounded-t-lg border-t border-gray-600 shadow-2xl"></div>
                    </div>
                    ...
                    <div className="bg-purple-800 text-white rounded-2xl p-6 relative overflow-hidden flex flex-col items-center">
                        <div className="z-10 text-center mt-4">
                            <h2 className="text-4xl font-bold leading-tight">PS5 Pro <br /> Edition</h2>
                            <p className="text-xs uppercase tracking-widest text-purple-200 mt-2 rotate-90 absolute right-[-20px] top-[40%] origin-center whitespace-nowrap">Elevate your game</p>
                        </div>
                        {/* Placeholder Image */}
                ...
                <div className="mt-12 flex flex-wrap justify-center gap-8 md:gap-16">
                    ...
                    <CategoryItem icon={<Keyboard />} label="Accessories" /> {/* Fixed typo from image 'Accesories' */}
