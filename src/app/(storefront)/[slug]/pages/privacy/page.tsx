  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: safeJsonLdStringify(privacySchema) }} // nosemgrep: typescript.react.security.audit.react-dangerouslysetinnerhtml.react-dangerouslysetinnerhtml
      />
      <PrivacyPageClient
        merchant={merchant}
