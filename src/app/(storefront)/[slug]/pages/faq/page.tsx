  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: safeJsonLdStringify(faqSchema) }} // nosemgrep: typescript.react.security.audit.react-dangerouslysetinnerhtml.react-dangerouslysetinnerhtml
      />
      <FAQPageClient
        merchant={merchant}
        faqItems={faqItems}
