...
import { ArrowLeft, LayoutTemplate, Loader2, Lock, Check } from 'lucide-react';
...
import { TEMPLATES, getTemplateData } from '@/config/templates';
...
class EditorErrorBoundary extends Component<{ children: ReactNode, onClose: () => void }, { hasError: boolean, error: Error | null }> {
...
class FloatingControlsErrorBoundary extends Component<{ children: ReactNode }, { hasError: boolean }> {
...
export function OnboardingTemplateEditor({
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-background flex flex-col animate-in fade-in duration-300">
            <div className="flex-1 overflow-hidden relative" id="puck-editor-container">
            ...
            <Sheet open={isTemplatesOpen} onOpenChange={setIsTemplatesOpen}>
                <SheetContent side="right" className="w-[400px] sm:w-[540px] overflow-y-auto">
                    <SheetHeader>
                        ...
                        <SheetDescription>
                            Select a starting point for your store. You can customize it further in the editor.
                        </SheetDescription>
                    </SheetHeader>
                        ...
                        {TEMPLATES.map((template) => (
                            <div
                                ...
                                className={cn(
                                    ...
                                    selectedTemplateId === template.id && "border-primary bg-muted/20 ring-1 ring-primary"
                                )}
