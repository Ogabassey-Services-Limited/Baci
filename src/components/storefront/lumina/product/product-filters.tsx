...
export function LuminaProductFilters({
  categories,
  selectedCategory,
  onSelectCategory,
  minPrice,
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-3">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all duration-200 border active:scale-95 active:bg-gray-50',
          ...
          <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto border-t lg:border-none pt-3 lg:pt-0">
            {/* Dynamic Filter Bar */}
            <div
              className="flex items-center gap-3 flex-1 lg:flex-none w-full lg:w-auto min-w-0"
              ref={filterMenuRef}
            >
              {/* Filter Type Toggle */}
                    ...
                    <div className="flex overflow-x-auto hide-scrollbar gap-2 pr-0">
                      {['All', ...brands].map((brand) => (
                        <button
                          ...
                          className={cn(
                            'px-3 py-1.5 text-xs font-bold rounded-md whitespace-nowrap transition-colors border flex-shrink-0',
                            selectedBrand === brand
                  ...
                  <div className="flex bg-gray-100 p-1 rounded-lg w-full overflow-hidden">
                    {['All', 'New', 'Used'].map((condition) => (
                      <button
                        ...
                        className={cn(
                          'flex-1 py-1.5 text-xs font-bold rounded-md transition-all whitespace-nowrap px-1',
              ...
              <button
                ...
                className={cn(
                  ...
                  viewMode === 'grid'
                    ...
                    : 'text-gray-400 md:hover:text-gray-600'
                )}
                title="Grid View"
              >
                <LayoutGrid size={18} />
