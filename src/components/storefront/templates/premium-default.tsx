...
export function PremiumDefaultTemplate() {
    ...
    const heroSlides = [
        {
            image: PlaceHolderImages.find(img => img.id === 'hero-fashion-1')?.imageUrl || 'https://images.unsplash.com/photo-1441986300917-64674bd600d8',
            title: "Elevate Your Style",
            subtitle: "Discover the latest trends in sustainable fashion. Curated just for you.",
            ctaText: "Shop Collection",
            ctaLink: "#products"
        },
        {
            image: PlaceHolderImages.find(img => img.id === 'hero-minimal-1')?.imageUrl || 'https://images.unsplash.com/photo-1445205170230-053b83016050',
        ...
        {
            image: PlaceHolderImages.find(img => img.id === 'hero-tech-1')?.imageUrl || 'https://images.unsplash.com/photo-1469334031218-e382a71b716b',
            title: "New Arrivals",
