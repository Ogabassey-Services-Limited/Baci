      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 w-full flex-1">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-gray-500 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
            Is your "Brand New" iPhone actually refurbished?{' '}
            <span className="text-gray-900 font-medium">
              Verify activation dates
            </span>
            , check warranty status, and avoid stolen devices instantly.
          </p>
          ...
          <div className="mt-6 flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 text-sm text-gray-500">
            <div className="flex items-center gap-2">
              ...
              <span>
                Dial <strong className="text-gray-900">*#06#</strong> on your
                device
              </span>
            </div>
        ...
        {result && (
          <div className="max-w-2xl mx-auto mb-16 animate-in slide-in-from-bottom-8 duration-700">
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
              {/* Header */}
              <div
                className={`p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 ${result.status === 'Clean' ? 'bg-green-50/50' : 'bg-red-50/50'}`}
              >
                <div>
              ...
              <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-gray-50/50 border border-gray-100">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${result.blacklistStatus === 'Clean' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'}`}
                  >
                    <ShieldCheck size={20} />
                  </div>
                  <div>
                    ...
                    <p
                      className={`font-bold text-base ${result.blacklistStatus === 'Clean' ? 'text-green-700' : 'text-red-600'}`}
                    >
                ...
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-gray-50/50 border border-gray-100">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${result.icloud === 'Clean' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'}`}
                  >
                    <Lock size={20} />
                  </div>
                  <div>
                    ...
                    <p
                      className={`font-bold text-base ${result.icloud === 'Clean' ? 'text-green-700' : 'text-red-600'}`}
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-16">
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center">
              ...
              <p className="text-sm text-gray-500">
                If a "Brand New" phone has an activation date from months ago,
                it's not new. We tell you the truth.
              </p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center">
              ...
              <p className="text-sm text-gray-500">
                Verify if Find My iPhone or iCloud Lock is active. Don't buy a
                paperweight.
              </p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center">
              ...
              <p className="text-sm text-gray-500">
                See the original purchase date and check if the manufacturer
