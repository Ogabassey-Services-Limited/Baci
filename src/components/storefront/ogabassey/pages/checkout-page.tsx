...
export const CheckoutPage: React.FC = () => {
  ...
  const [addresses, _setAddresses] = useState<SavedAddress[]>([
    ...
    },
    {
      id: 2,
      label: 'Office',
      address: 'Tech Hub, 45 Admiralty Way, Lekki, Lagos',
  ...
  const deliveryCost =
    deliveryMethod === 'pickup' ? 0 : deliveryMethod === 'door' ? 2500 : 5000;
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      if (paymentMethod === 'paystack') {
        // Initialize payment via API (creates transaction record for webhook)
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                <div className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-xs">
                  1
                </div>
                Contact Information
              </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-red-500 text-sm"
                      required
                    />
                  </div>
                  <div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="space-y-3">
                {/* Office Pickup */}
                <label
                  className={`flex items-center p-4 rounded-xl border cursor-pointer transition-all ${deliveryMethod === 'pickup' ? 'border-red-600 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                >
                  <input
                    type="radio"
                    name="delivery"
                  ...
                  <div className="ml-4 flex-1">
                    <div className="flex justify-between">
                      <span className="font-bold text-gray-900 flex items-center gap-2">
                        <Building2 size={16} /> Office Pickup
                      </span>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Pick up from our Ikeja Store. Ready in 2 hours.
                    </p>
                  </div>
                </label>
                ...
                {/* Door Delivery */}
                <label
                  className={`flex items-center p-4 rounded-xl border cursor-pointer transition-all ${deliveryMethod === 'door' ? 'border-red-600 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                >
                  <input
                    type="radio"
                    name="delivery"
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <div className="text-xs text-gray-500 mt-1 space-y-1">
                      ...
                      <p className="text-red-500 flex items-center gap-1">
                        <Info size={10} /> If address is within Lagos delivery
                        is between 24 - 48 working hours.
                      </p>
                    </div>
                  </div>
                </label>
                ...
                {/* Airport Delivery */}
                <label
                  className={`flex items-center p-4 rounded-xl border cursor-pointer transition-all ${deliveryMethod === 'airport' ? 'border-red-600 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                >
                  <input
                    type="radio"
                    name="delivery"
                  ...
                  <div className="ml-4 flex-1">
                    <div className="flex justify-between">
                      <span className="font-bold text-gray-900 flex items-center gap-2">
                        <Plane size={16} /> Airport Delivery (Outside Lagos)
                      </span>
                      <span className="font-bold text-gray-900 text-sm">
                        ₦5,000
                      </span>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Airport delivery within 24 working hours.
                    </p>
                  </div>
                </label>
              </div>
              ...
              <div className="space-y-4">
                ...
                {remainingAmount > 0 && (
                  <div className="animate-in fade-in slide-in-from-top-2 space-y-4 pt-2">
                    ...
                    {/* Pay Later */}
                    <label
                      className={`flex items-center p-4 rounded-xl border cursor-pointer transition-all ${paymentMethod === 'invoice' ? 'border-red-600 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                    >
                      <input
                        type="radio"
                        name="payment"
                      ...
                      <div className="ml-4 flex-1">
                        <span className="font-bold text-gray-900 flex items-center gap-2">
                          <FileText size={16} /> Generate Invoice (Pay Later)
                        </span>
                        <p className="text-xs text-gray-500 mt-0.5">
                          Receive an invoice now and pay via transfer later.
                        </p>
                      </div>
                    </label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {/* Paystack */}
                      <label
                        className={`flex items-center p-3 rounded-xl border cursor-pointer transition-all ${paymentMethod === 'paystack' ? 'border-red-600 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                      >
                        <input
                          type="radio"
                          name="payment"
                      ...
                      {/* Pay for Me */}
                      <div
                        className={`p-3 rounded-xl border transition-all ${paymentMethod === 'payforme' ? 'border-red-600 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                      >
                        <label className="flex items-center cursor-pointer">
                          ...
                          <div className="ml-3">
                            <span className="font-bold text-sm text-gray-900 flex items-center gap-2">
                              <Share2 size={14} /> Pay For Me
                            </span>
                            <p className="text-[10px] text-gray-500">
                              Send payment link to someone else
                            </p>
                          </div>
                        </label>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['CredPal', 'CreditDirect', 'Klump', 'Korapay'].map(
                        (provider) => (
                          <label
                            key={provider}
                            className={`flex items-center p-3 rounded-xl border cursor-pointer transition-all ${paymentMethod === provider.toLowerCase() ? 'border-red-600 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                          >
                            <input
                              type="radio"
                              name="payment"
                              ...
                              onChange={() =>
                                setPaymentMethod(provider.toLowerCase())
                              }
                              className="w-4 h-4 text-red-600 focus:ring-red-500 border-gray-300"
                            />
                            <div className="ml-3">
