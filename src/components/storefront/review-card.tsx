...
export function ReviewCard({ review, className }: ReviewCardProps) {
    ...
    const displayName = review.customer_name || review.customer_email.split('@')[0];
    ...
    const handleHelpfulVote = async () => {
        ...
        try {
            ...
            const voterIdentifier = localStorage.getItem('customerEmail') ||
    ...
    return (
        <div className={cn('border-b pb-6 last:border-b-0', className)}>
            ...
            <div className="mt-4 flex items-center gap-4">
                ...
                >
                    <ThumbsUp className={cn('w-4 h-4 mr-1', hasVoted && 'fill-current')} />
