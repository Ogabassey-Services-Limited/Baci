        ...
        <div className="bg-gradient-to-r from-red-600 to-red-800 text-white rounded-2xl p-8 md:p-12 mb-10 relative overflow-hidden shadow-xl">
          <div className="relative z-10 max-w-lg">
            ...
            <p className="text-white/80 mb-8 text-sm md:text-base">
              Get an instant estimate and swap your phone, laptop, or console
              for a brand new one in 3 easy steps.
            </p>
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: '1. Describe It',
                desc: 'Tell us the model and condition of your device.',
                icon: Smartphone,
              },
              {
                title: '2. Get Offer',
                desc: 'Receive an instant trade-in value estimate.',
                icon: DollarSign,
              },
              {
                title: '3. Swap It',
                desc: 'Bring it in or ship it to us, and get your new device.',
                icon: RefreshCw,
              },
            ].map((step, idx) => (
              <div
