      ...
      <div className="relative bg-[#064e3b] text-white py-20 md:py-32 overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-6 relative z-10 text-center">
          ...
          <p className="text-green-100/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            At Ogabassey, we believe innovation shouldn't cost the earth. We are
            committed to sustainable practices that protect our environment for
            future generations.
          </p>
        </div>
        ...
        <div className="bg-green-50 rounded-3xl p-8 md:p-12 mb-20 border border-green-100 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                <strong>
                  Since 2020, Ogabassey has stopped issuing physical receipts.
                </strong>{' '}
                This wasn't just a cost-saving measure; it was a deliberate
                choice to align our operations with global sustainability
                standards.
              </p>
              <p>
                Traditional receipts are often coated with BPA (Bisphenol A) or
                BPS (Bisphenol S), making them non-recyclable. By switching to
                100% digital invoices, we eliminate this toxic waste, save
                trees, and provide you with a permanent, searchable record of
                your purchases.
              </p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-green-50 p-4 rounded-xl text-center">
                  <span className="block text-2xl font-extrabold text-green-700">
                    4+
                  </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-blue-50 rounded-2xl p-8 border border-blue-100 relative overflow-hidden group hover:shadow-lg transition-all">
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">
                  Device Longevity Education
                </h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  The most sustainable device is the one that lasts. We actively
                  educate our community on how to extend battery life, protect
                  screens, and optimize performance through our{' '}
                  <strong>Tech Insights Blog</strong>.
                </p>
                <Link
                  to="/blog"
                  className="inline-flex items-center gap-2 font-bold text-blue-700 hover:gap-3 transition-all"
                >
            ...
            <div className="bg-indigo-50 rounded-2xl p-8 border border-indigo-100 relative overflow-hidden group hover:shadow-lg transition-all">
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  To prevent premature disposal, we offer{' '}
                  <strong>free charging port and speaker cleaning</strong> for
                  all walk-in customers. Simple maintenance often fixes "broken"
                  devices, saving them from becoming e-waste.
                </p>
                <Link
                  to="/repairs"
                  className="inline-flex items-center gap-2 font-bold text-indigo-700 hover:gap-3 transition-all"
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-24">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent">
              <div className="absolute bottom-8 left-8 text-white">
                ...
                <p className="text-sm text-gray-300">
                  Where we give devices a second chance.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6 text-gray-600 leading-relaxed">
              <p>
                The most sustainable device is the one you already own. Our{' '}
                <strong>Repair Department</strong> is dedicated to keeping your
                gadgets running for as long as possible, actively fighting the
                culture of disposable tech.
              </p>
              <p>
                From battery replacements to complex motherboard microsoldering,
                every repair we perform prevents a device from becoming
                premature electronic waste in a landfill.
              </p>
            </div>

            <div className="mt-8 pt-8 border-t border-gray-100 bg-gray-50 rounded-2xl p-6">
              <h4 className="font-bold text-gray-900 mb-4 flex items-center gap-2">
                <Recycle className="text-green-600" size={18} /> What happens to
                the broken parts?
              </h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-gray-500 leading-tight mt-1">
                      Hazardous li-ion batteries are neutralized by certified
                      partners.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-gray-500 leading-tight mt-1">
                      Working chips are salvaged from dead boards for future
                      repairs.
                    </p>
                  </div>
                </div>
        ...
        <div className="mb-20">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-gray-500">
              We are proud to align our business practices with the United
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {sdgs.map((sdg) => (
              <div
                key={sdg.id}
                className="flex overflow-hidden rounded-2xl shadow-sm border border-gray-100 bg-white"
              >
                <div
                  className={`${sdg.color} w-24 flex items-center justify-center p-4 text-white font-black text-4xl shrink-0`}
                >
                  {sdg.id}
                </div>
                <div className="p-6">
        ...
        <div className="bg-[#1a1a1a] rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-gray-400 mb-8 max-w-lg mx-auto">
              Make a difference with your next upgrade. Trade in your old device
              or buy a certified UK Used gadget today.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                to="/swap"
                className="bg-green-600 text-white font-bold py-3.5 px-8 rounded-xl hover:bg-green-700 transition-colors shadow-lg active:scale-95 flex items-center justify-center gap-2"
              >
