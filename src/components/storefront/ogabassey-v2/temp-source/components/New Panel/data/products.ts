...
export const products: Product[] = [
  ...
  },
  {
    ...
    image:
      'https://upload.wikimedia.org/wikipedia/commons/9/90/Sony-PlayStation-5-DualSense-Controller-FL.png',
    rating: 4.9,
    category: 'Gaming',
    condition: 'New',
    brand: 'Sony',
  ...
  },
  {
    ...
    image:
      'https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_Watch_Series_5_gold_aluminum_case_with_sport_band.png',
    rating: 5,
  ...
  },
  {
    ...
    image:
      'https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lowres/c06950766.png',
    rating: 4.2,
    category: 'Laptops',
    condition: 'Used',
    brand: 'HP',
  ...
  },
  {
    ...
    image:
      'https://resource.logitechg.com/w_692,c_limit,q_auto,f_auto,dpr_1.0/d_transparent.gif/content/dam/gaming/en/products/g502-lightspeed/g502-lightspeed-hero.png?v=1',
    rating: 4.7,
    category: 'Accessories',
    condition: 'New',
    brand: 'Logitech',
  ...
  },
  {
    ...
    image:
      'https://i1.adis.ws/i/canon/pixma-ts3350-series-black-frt-paper_range?w=500&sm=aspect&aspect=4:3&qlt=80',
    rating: 4.3,
    category: 'Printers',
    condition: 'New',
    brand: 'Canon',
