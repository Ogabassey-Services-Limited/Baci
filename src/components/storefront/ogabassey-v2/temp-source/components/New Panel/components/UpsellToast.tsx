...
export const UpsellToast: React.FC<UpsellToastProps> = ({
  ...
  const [suggestedProduct, setSuggestedProduct] = useState<Product | null>(
    null
  );
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl border border-red-100 overflow-hidden relative">
        {/* Progress Bar */}
        <div
          className={`absolute top-0 left-0 h-1 bg-red-600 transition-all duration-[8000ms] ease-linear z-10 ${isVisible ? 'w-full' : 'w-0'}`}
        />
        ...
        <div className="p-4 pt-5">
          ...
          <p className="text-xs text-gray-500 mb-3 pl-6">
            Complete the set with this offer.
          </p>
