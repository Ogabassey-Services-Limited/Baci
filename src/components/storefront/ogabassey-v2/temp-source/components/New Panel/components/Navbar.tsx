    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 md:gap-3 pb-0 pt-1 md:py-5 px-4 md:px-6">
          ...
          <div className="flex items-center justify-between md:justify-start w-full md:w-auto gap-4">
            ...
            <div className="flex md:hidden items-center gap-4 text-white">
              ...
              >
                ...
                <span
                  className={`absolute -top-0.5 -right-0.5 bg-red-600 text-white text-[10px] font-bold h-4 w-4 rounded-full flex items-center justify-center border border-[#0F0F0F] transition-all ${totalItems > 0 ? 'scale-100' : 'scale-0'}`}
                >
                  {totalItems}
                </span>
              </button>
          ...
          <div
            className="w-full md:flex-1 md:max-w-2xl md:mx-4 lg:mx-12"
            ref={searchRef}
          >
                    ...
                    {isSearching ? (
                      ...
                      <div>
                        ...
                        <ul className="space-y-3">
                          {results.map((item, idx) => (
                            ...
                            >
                              <div>
                                <p className="font-bold text-gray-900 md:group-hover:text-red-600 transition-colors">
                                  {item.name}
                                </p>
                      ...
                      <div className="flex flex-col items-center justify-center py-6 text-center text-gray-500">
                        ...
                        <p className="text-xs mt-1 max-w-[200px]">
                          We couldn't find a match for "{query}". Try a
          ...
          <div className="hidden md:flex items-center gap-5 shrink-0 text-white/80">
            ...
            >
              ...
              <span
                className={`absolute -top-1 -right-1 bg-red-600 text-white text-[11px] font-bold h-5 w-5 rounded-full flex items-center justify-center border-2 border-[#0F0F0F] shadow-sm transition-all duration-300 ${totalItems > 0 ? 'scale-100' : 'scale-0'} md:group-hover:bg-white md:group-hover:text-red-600 md:group-hover:border-transparent`}
              >
                {totalItems}
              </span>
            </button>
