            ...
            <div className="grid grid-cols-2 gap-16 mb-16 border-b-2 border-gray-100 pb-16">
              ...
              <div className="text-right space-y-8">
                ...
                <div>
                  ...
                  <p className="font-bold text-red-600 text-4xl">
                    {order.total}
                  </p>
                </div>
              </div>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b-2 border-gray-100">
                    <th className="pb-6 text-xs font-bold text-gray-400 uppercase tracking-wider w-1/2">
                      Item Description
                    </th>
                    <th className="pb-6 text-center text-xs font-bold text-gray-400 uppercase tracking-wider">
                      Qty
                    </th>
                    <th className="pb-6 text-right text-xs font-bold text-gray-400 uppercase tracking-wider">
                      Price
                    </th>
                    <th className="pb-6 text-right text-xs font-bold text-gray-400 uppercase tracking-wider">
                      Amount
                ...
                <tbody className="divide-y divide-gray-50">
                  {order.items.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td className="py-8 text-right text-gray-600 font-medium">
                        {item.price}
                      </td>
                      <td className="py-8 text-right font-bold text-gray-900 text-lg">
                        {item.price}
                      </td>
                    </tr>
                  ))}
