      ...
      <div className="relative bg-[#1a1a1a] text-white py-20 md:py-32 overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-6 relative z-10 text-center">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Ogabassey is Nigeria's premier destination for high-quality new and
            UK-used gadgets. We are bridging the digital divide, one device at a
            time.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center mb-24">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6 text-gray-600 leading-relaxed">
              ...
              <p>
                Ogabassey stepped in to fill that gap. By sourcing directly from
                verified global suppliers and implementing a rigorous quality
                check process, we ensure that every "UK Used" or "Brand New"
                device you buy from us is authentic and reliable.
              </p>
        ...
        <div className="bg-red-600 rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
          <div className="relative z-10">
            ...
            <p className="text-red-100 text-lg mb-8 max-w-xl mx-auto">
              Join thousands of satisfied customers and experience the Ogabassey
              difference today.
            </p>
            <Link
              to="/"
