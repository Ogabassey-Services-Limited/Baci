          ...
          <div className="flex justify-between md:justify-start gap-12">
            <div>
              ...
              <ul className="space-y-2 text-xs text-gray-400">
                ...
                <li>
                  <Link to="/legal" className="hover:text-red-500">
                    Legal & Disputes
                  </Link>
                </li>
                <li>
                  <Link to="/sustainability" className="hover:text-red-500">
                    Sustainability
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-gray-400">
                <li>
                  <Link to="/repairs" className="hover:text-red-500">
                    Repairs
                  </Link>
                </li>
                <li>
                  <Link to="/swap" className="hover:text-red-500">
                    Sell Device
                  </Link>
                </li>
                <li>
