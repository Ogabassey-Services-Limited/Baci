...
export const ProductDetails: React.FC = () => {
  ...
  const cartItem = currentCartItemId
    ? cartItems.find((item) => item.cartItemId === currentCartItemId)
    : undefined;
    ...
    <div className="bg-white pb-32 pt-4 relative">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6">
        ...
        <nav className="flex items-center text-sm text-gray-500 mb-8 overflow-x-auto whitespace-nowrap pb-2">
          <Link to="/" className="md:hover:text-red-600 transition-colors">
            Home
          </Link>
      ...
      <NegotiationModal
        ...
        onSuccess={(price) => {
          ...
          if (
            (selectedColor !== null || productData.colors.length === 0) &&
            (selectedStorage !== null || productData.storage.length === 0)
          ) {
            const productToAdd = getProductForCart();
