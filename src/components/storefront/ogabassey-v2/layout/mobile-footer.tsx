...
export const MobileFooter: React.FC = () => {
  ...
  const isActive = (path: string) => {
    if (path === '/profile') {
      ...
      return ['/profile', '/orders', '/receipts', '/addresses', '/member-status', '/reviews', '/repairs', '/swap', '/notifications', '/security', '/help'].includes(pathname || '');
    }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 relative z-10">
        ...
        {/* Home */}
        <Link href="/" className="flex flex-col items-center justify-center active:scale-90 transition-transform">
        ...
        {/* Saved */}
        <Link href="/saved" className="flex flex-col items-center justify-center active:scale-90 transition-transform">
        ...
        {/* Wallet */}
        <Link href="/wallet" className="flex flex-col items-center justify-center active:scale-90 transition-transform">
        ...
        {/* Profile */}
        <Link href="/profile" className="flex flex-col items-center justify-center active:scale-90 transition-transform">
...
export { MobileFooter as OgabasseyV2MobileFooter };
