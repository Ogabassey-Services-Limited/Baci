...
export const OgabasseyV2Navbar: React.FC<NavbarProps> = ({
  logo,
  storeName,
  storeSlug,
  showSearch = true,
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 md:gap-3 py-3 md:py-4 px-4 md:px-6">
              ...
              <div className="flex items-center justify-between md:justify-start w-full md:w-auto gap-4">
                ...
                <div className="flex items-center gap-4 shrink-0">
                  ...
                  <Link href="/" className="flex items-center cursor-pointer select-none active:opacity-80 transition-opacity text-white">
                    {logo ? (
                      <img src={logo} alt={storeName || "Store Logo"} className="h-8 w-auto object-contain" />
                    ) : (
