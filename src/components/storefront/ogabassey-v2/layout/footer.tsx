...
export const OgabasseyV2Footer: React.FC<FooterProps> = ({ storeSlug, logo }) => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center cursor-pointer select-none">
              {logo ? (
                <img src={logo} alt="Ogabassey" className="h-8 w-auto object-contain" />
              ) : (
                <span className="text-xl font-bold text-white">Ogabassey</span>
              )}
            </Link>
