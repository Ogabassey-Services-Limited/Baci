...
export const OgabasseyV2CartSidebar: React.FC<OgabasseyV2CartSidebarProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  const applyNegotiatedPrice = (_cartItemId: string, _price: number) => {
    console.log('Negotiation not available in preview');
  };
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const applyCartWideNegotiation = (_totalPrice: number) => {
    console.log('Cart-wide negotiation not available in preview');
  };
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const toggleAssurance = (_cartItemId: string) => {
    console.log('Assurance not available in preview');
  };
