...
import { Filter, ChevronDown, Check, Star, LayoutGrid, List, X } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-2 overflow-x-auto hide-scrollbar pb-1 -mx-4 px-4 md:mx-0 md:px-0">
                        {categories.map((category) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-full text-sm font-bold whitespace-nowrap transition-all active:scale-95 ${selectedCategory === category
                        ...
                        <div className="flex items-center gap-2 flex-1 min-w-0">
                            ...
                            <div className="relative" ref={filterMenuRef}>
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-bold transition-colors border ${activeFilterType || isFilterMenuOpen ? 'bg-red-50 text-red-600 border-red-100' : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50'
                                        }`}
                                >
                                    <Filter size={16} />
                                    ...
                                    <>
                                        ...
                                        <div className="relative flex-1">
                                            ...
                                            <input
                                                ...
                                                value={(maxPrice > 0 && maxPrice < 100000000) ? maxPrice.toLocaleString() : ''}
                                                onChange={(e) => {
                                                    const val = parseInt(e.target.value.replace(/[^0-9]/g, ''), 10);
