...
import { Instagram, Facebook, Twitter, Youtube, Linkedin, Music, MapPin, Phone, Mail, Apple } from 'lucide-react';
...
export const Footer: React.FC = () => {
    return (
        <footer className="bg-[#0a0a0a] text-white pt-20 pb-10 relative overflow-hidden">
            ...
            <div className="absolute -top-40 -right-40 w-80 h-80 bg-red-600/5 rounded-full blur-3xl pointer-events-none"></div>
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-[300px] bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-[0.03] pointer-events-none"></div>
                    ...
                    <div className="flex justify-between md:justify-start gap-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-xs text-gray-400">
                                ...
                                <li><Link href="/swap" className="hover:text-red-500">Sell Device</Link></li>
                                <li><Link href="/orders" className="hover:text-red-500">Track Order</Link></li>
                                <li><Link href="/help" className="hover:text-red-500">Support</Link></li>
                            </ul>
                        </div>
                    </div>
