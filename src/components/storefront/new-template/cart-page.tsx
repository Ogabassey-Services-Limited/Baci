        ...
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <main className="max-w-[1400px] mx-auto px-4 md:px-6 py-8 md:py-12">
                <div className="flex items-center gap-2 mb-8">
                    <Link href="/" className="flex items-center gap-2 text-gray-500 hover:text-red-600 transition-colors">
                        <ArrowLeft size={20} />
                ...
                <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
                    Your Cart <span className="text-gray-400 font-normal">({cart.length} items)</span>
                </h1>
                ...
                {cart.length === 0 ? (
                    <div className="bg-white rounded-3xl p-12 text-center shadow-sm border border-gray-100">
                        ...
                        <p className="text-gray-500 mb-8 max-w-md mx-auto">
                            Looks like you haven't added anything to your cart yet. Browse our products to find great deals!
                        </p>
                        <Link
                            href="/"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            {cart.map((item: any) => (
                                <div key={item.variant_id || item.id} className="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100 flex gap-4 md:gap-6 group transition-all hover:shadow-md">
                                    ...
                                    <div className="flex-1 flex flex-col justify-between">
                                        ...
                                        <div className="flex items-end justify-between gap-4">
                                            <div className="flex items-center bg-gray-100 rounded-lg p-1">
                                                <button
                                                    onClick={() => updateQuantity(item.id, Math.max(1, item.quantity - 1), item.variant_id)}
                            ...
                            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 sticky top-24">
                                ...
                                <div className="border-t border-gray-100 pt-4 mb-8">
                                    <div className="flex justify-between items-end">
                                        ...
                                        <span className="font-bold text-3xl text-gray-900">₦{cartTotal.toLocaleString()}</span>
                                    </div>
                                </div>

                                <Link href="/checkout" className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-6 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-red-600/20 active:scale-[0.98] mb-4">
