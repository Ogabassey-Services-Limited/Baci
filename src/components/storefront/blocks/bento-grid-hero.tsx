...
export function BentoGridHero({
    ...
    return (
        <section className={cn("container mx-auto px-4 py-6", heightClasses[height])}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-full">
                ...
                <div className="md:col-span-2 relative rounded-2xl overflow-hidden group h-full">
                    <Link href={asRoute(safeImages[0].ctaLink || '#')} className="block w-full h-full">
                        <Image
                        ...
                        <div className={cn("absolute bottom-8 left-8 max-w-lg", safeImages[0].textColor || 'text-white')}>
                            {safeImages[0].title && (
                ...
                <div className="flex flex-col gap-4 h-full">
                    ...
                    <div className="relative flex-1 rounded-2xl overflow-hidden group">
                        <Link href={asRoute(safeImages[1].ctaLink || '#')} className="block w-full h-full">
                            <Image
                            ...
                            <div className={cn("absolute bottom-6 left-6", safeImages[1].textColor || 'text-white')}>
                                {safeImages[1].title && <h3 className="text-2xl font-bold mb-1">{safeImages[1].title}</h3>}
                                {safeImages[1].subtitle && <p className="text-sm opacity-90">{safeImages[1].subtitle}</p>}
                            </div>
                        </Link>
                    </div>
                    ...
                    {/* Bottom Right */}
                    <div className="relative flex-1 rounded-2xl overflow-hidden group">
                        <Link href={asRoute(safeImages[2].ctaLink || '#')} className="block w-full h-full">
                            <Image
                            ...
                            />
                            <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
                            <div className={cn("absolute bottom-6 left-6", safeImages[2].textColor || 'text-white')}>
                                {safeImages[2].title && <h3 className="text-2xl font-bold mb-1">{safeImages[2].title}</h3>}
                                {safeImages[2].subtitle && <p className="text-sm opacity-90">{safeImages[2].subtitle}</p>}
                            </div>
                        </Link>
                    </div>
                </div>
