            ...
            <div className="container mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-neutral-400 text-sm leading-relaxed">
                            Premium quality products curated with care. We believe in style, sustainability, and customer satisfaction.
                        </p>
                    </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-neutral-400 text-sm">
                                ...
                                {quickLinks.map((link, index) => (
                                    <li key={index}>
                                        <Link href={asRoute(link.url)} className="hover:text-white transition-colors">
                                            {link.label}
                                        </Link>
                                    </li>
                                ))}
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-neutral-500 text-sm">
                        {copyrightText || `© ${new Date().getFullYear()} ${businessName}. Powered by Baci.`}
                    </p>
