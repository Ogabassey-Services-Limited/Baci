      ...
      <div className={cn('flex items-center gap-2', className)}>
        ...
        <div className="flex items-center gap-1">
          <Button
            variant="ghost"
            size="icon"
            className={cn(sizeClasses[size], 'hover:bg-[#1877F2]/10 hover:text-[#1877F2]')}
          ...
          <Button
            variant="ghost"
            size="icon"
            className={cn(sizeClasses[size], 'hover:bg-black/10 hover:text-black dark:hover:bg-white/10 dark:hover:text-white')}
          ...
          <Button
            variant="ghost"
            size="icon"
            className={cn(sizeClasses[size], 'hover:bg-[#25D366]/10 hover:text-[#25D366]')}
          ...
          {imageUrl && (
            <Button
              variant="ghost"
              size="icon"
              className={cn(sizeClasses[size], 'hover:bg-[#E60023]/10 hover:text-[#E60023]')}
          ...
          >
            {copied ? <Check className={iconSizeClasses[size]} /> : <Link2 className={iconSizeClasses[size]} />}
          </Button>
        </div>
      </div>
    );
