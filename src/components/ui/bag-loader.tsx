...
export function BagLoader({ className, size = 48 }: BagLoaderProps) {
    // Configuration for "planetary" orbits
    // Organized rotation: particles follow a similar path with even spacing
    const duration = 2.5;
    const particles = [
        { color: '#f0bf58', size: 6, delay: 0 },
        { color: '#f0bf58', size: 4, delay: duration * 0.16 },
        { color: '#23255d', size: 5, delay: duration * 0.33 },
        { color: '#f0bf58', size: 3, delay: duration * 0.5 },
    ];
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                <motion.div
                    animate={{
                        y: [-2, 2, -2], // Subtle floating motion
                    }}
                    transition={{
                        duration: 3,
                        repeat: Infinity,
                ...
                return (
                    <motion.div
                        ...
                        style={{
                            ...
                            transformOrigin: `0px ${ry}px`, // Not used for this xy animation but kept for ref
                        }}
                        animate={{
                            x: [rx, 0, -rx, 0, rx],
                            y: [0, ry, 0, -ry, 0],
                            scale: [0.8, 1.2, 0.8, 0.6, 0.8], // Larger when "front", smaller when "back"
                            zIndex: [20, 20, 20, 0, 20], // High z-index when in front (y > 0), low when back
                        }}
                        transition={{
                            duration: duration,
                            repeat: Infinity,
