...
export function GeminiCommandBar({ onCommand, isLoading, compact = false }: GeminiCommandBarProps) {
                    ...
                    <div className="flex gap-2">
                        <div className="relative flex-1">
                            <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
                                ...
                                <span className="text-xs font-medium text-purple-600 hidden sm:inline">Gemini AI</span>
                            </div>
                            <Input
                                value={command}
                                onChange={(e) => setCommand(e.target.value)}
