        ...
        <ScrollArea className="h-full">
            <div className="p-4 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => handleChange('site', 'currency', value)}
                                >
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => handleChange('site', 'units', value)}
                                >
                                    <SelectTrigger id="units">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                                        <SelectItem value="imperial">Imperial (lb, oz, in)</SelectItem>
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                onValueChange={(value) => handleChange('site', 'timezone', value)}
                            >
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                onValueChange={(value) => handleChange('site', 'language', value)}
                            >
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) => handleChange('site', 'logoUrl', e.target.value)}
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) => handleChange('site', 'faviconUrl', e.target.value)}
                ...
                <Card className="p-4 space-y-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            <Label htmlFor="ga4">Google Analytics 4 (GA4) Measurement ID</Label>
                            <Input
                                id="ga4"
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) => handleChange('analytics', 'tiktokPixelId', e.target.value)}
                        ...
                        <div>
                            ...
                            <Textarea
                                ...
                                onChange={(e) => handleChange('analytics', 'customTrackingCode', e.target.value)}
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <Textarea
                                ...
                                onChange={(e) => handleChange('customCode', 'customCss', e.target.value)}
                        ...
                        <div>
                            ...
                            <Textarea
                                ...
                                onChange={(e) => handleChange('customCode', 'customJs', e.target.value)}
                        ...
                        <div>
                            <Label htmlFor="head-scripts">Head Scripts (before &lt;/head&gt;)</Label>
                            <Textarea
                                id="head-scripts"
                                value={data.customCode.headScripts || ''}
                                onChange={(e) => handleChange('customCode', 'headScripts', e.target.value)}
                        ...
                        <div>
                            <Label htmlFor="body-scripts">Body Scripts (before &lt;/body&gt;)</Label>
                            <Textarea
                                id="body-scripts"
                                value={data.customCode.bodyScripts || ''}
                                onChange={(e) => handleChange('customCode', 'bodyScripts', e.target.value)}
                ...
                <Card className="p-4 bg-primary/5 border-primary/20">
                    ...
                    <ul className="text-xs space-y-1.5 text-muted-foreground">
                        <li>• Add Google Analytics to track visitor behavior and conversions</li>
                        <li>• Meta Pixel is essential for Facebook/Instagram ad tracking</li>
