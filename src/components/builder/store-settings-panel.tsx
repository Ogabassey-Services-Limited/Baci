            ...
            <div className="p-4 space-y-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectItem value="standard">Standard (Images Left)</SelectItem>
                                    <SelectItem value="wide">Wide (Full Width)</SelectItem>
                                    <SelectItem value="sidebar">Sidebar (Images + Info)</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => handleChange('productPage', 'enableZoom', checked)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => handleChange('productPage', 'showRelatedProducts', checked)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => handleChange('productPage', 'showReviews', checked)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => handleChange('productPage', 'showShareButtons', checked)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => handleChange('productPage', 'showInventory', checked)}
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('cart', 'enableCartDrawer', checked)}
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('cart', 'showShippingEstimate', checked)}
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('cart', 'showProgressBar', checked)}
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('cart', 'enableGiftMessage', checked)}
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('cart', 'enableDiscountCodes', checked)}
                            />
                        </div>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('checkout', 'enableGuestCheckout', checked)}
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('checkout', 'requirePhoneNumber', checked)}
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('checkout', 'showOrderNotes', checked)}
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('checkout', 'showNewsletterSignup', checked)}
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('checkout', 'enableExpressCheckout', checked)}
                            />
                        </div>
                    </div>
                </Card>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('shipping', 'showEstimatedDelivery', checked)}
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => handleChange('shipping', 'internationalShipping', checked)}
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) => handleChange('shipping', 'defaultShippingMessage', e.target.value)}
                ...
                <Card className="p-4 space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <Label htmlFor="privacy-policy">Privacy Policy (URL or Text)</Label>
                            <Textarea
                                id="privacy-policy"
