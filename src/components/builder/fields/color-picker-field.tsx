...
const PRESET_COLORS = [
    ...
    'var(--theme-primary)', 'var(--theme-secondary)', 'var(--theme-accent)', 'var(--theme-background)', 'var(--theme-foreground)'
];
                            ...
                            <div className="grid grid-cols-5 gap-2">
                                {PRESET_COLORS.map((color) => (
                                    <button
                                        key={color}
                                        className={cn(
                                            "w-8 h-8 rounded-full border shadow-sm transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-ring",
