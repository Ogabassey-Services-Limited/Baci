...
import { Star, Mail, Check, Quote, AlignJustify, Truck, Shield, Clock, Zap, Heart, Award } from 'lucide-react';
...
export const builderConfig: Config<{
    ...
    categories: {
        ...
        commerce: {
            title: 'Commerce',
            components: ['ProductGrid', 'Button', 'Newsletter'],
        },
    },
    root: {
        fields: {
    ...
    components: {
        ...
        HeroCarousel: {
            ...
            defaultProps: {
                slides: [
                    {
                        image: 'https://images.unsplash.com/photo-1669295384050-a1d4357bd1d7?auto=format&fit=crop&w=1600&q=80',
                        title: 'Welcome to Our Store',
