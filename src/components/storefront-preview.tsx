...
export function StorefrontPreview({
  ...
  const previewProducts =
    sampleProductsByCategory[businessType] || sampleProductsByCategory.other;
  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black/20">
            <div className="text-center text-white p-4">
              <h2 className="text-2xl font-bold mb-2 drop-shadow-md">
                Welcome to {businessName || 'Your Store'}
              </h2>
              <p className="text-sm mb-4 drop-shadow-md opacity-90">
                Discover our amazing collection
              </p>
              <ThemedButton colorRole="primary" size="sm">
                Shop Now
              </ThemedButton>
            </div>
          </div>
        ...
        <main className="p-6">
          <h2
            className="text-xl font-bold tracking-tighter text-center mb-6"
        ...
        >
          <p className="text-xs">
            &copy; {new Date().getFullYear()} {businessName || 'Your Store'}
          </p>
        </footer>
      </div>
    </div>
