...
const PLACEHOLDERS: Record<string, string> = {
    'fashion': 'e.g., A sustainable clothing brand focusing on minimalist designs and organic materials...',
    'electronics': 'e.g., A tech store specializing in smart home devices and high-end audio gear...',
    'home-goods': 'e.g., A home decor shop offering handcrafted furniture and artisanal textiles...',
    'health-beauty': 'e.g., A natural skincare line using organic ingredients for sensitive skin...',
    'handmade': 'e.g., A pottery studio creating unique, hand-thrown mugs and bowls...',
    'food-beverage': 'e.g., A gourmet burger joint serving locally sourced ingredients and craft beers...',
    'hair-extensions': 'e.g., A luxury hair extension brand offering 100% human hair bundles and wigs...',
    'default': 'e.g., A sustainable coffee shop that serves fair-trade beans and artisanal pastries in a cozy, modern atmosphere...'
};
...
export function BusinessNameGeneratorModal({
    ...
    const placeholder = businessType && PLACEHOLDERS[businessType]
                    ...
                    {generatedNames.length > 0 && (
                        <div className="space-y-3 animate-fade-in">
                            <div className="flex items-center justify-between">
                                ...
                                >
                                    <RefreshCw className={cn("mr-1 h-3 w-3", isGenerating && "animate-spin")} />
                                    Regenerate
                                </Button>
                            </div>
