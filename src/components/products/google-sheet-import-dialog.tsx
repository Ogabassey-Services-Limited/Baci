...
export function GoogleSheetImportDialog({ open, onOpenChange, onImport }: GoogleSheetImportDialogProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Enter the URL of your Google Sheet. Ensure the sheet is "Published to the web" (File &gt; Share &gt; Publish to web) or publicly accessible.
                    </DialogDescription>
                </DialogHeader>
