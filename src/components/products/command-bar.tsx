...
export function CommandBar() {
  const { products, setWorkflowStep, setAiResponse, searchTerm, setSearchTerm } = useProductContext();
      ...
      <div className="flex items-center gap-4">
        <form onSubmit={handleCommandSubmit} className="flex-1">
          <div className="relative">
            <Input
              type="text"
              placeholder={'Search products or enter an AI command (e.g., "update SKU-123 to $105")'}
              value={searchTerm}
