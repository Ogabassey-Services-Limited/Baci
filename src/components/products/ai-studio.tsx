...
import { Camera, Upload, X, Check, Loader2, Sparkles, Wand2 } from 'lucide-react';
...
export function AIStudio({ isOpen, onClose, onSuccess, productName }: AIStudioProps) {
        ...
        try {
            ...
            const blob = await removeBackground(imageUrl, {
                progress: (key, current, total) => {
                    setLoadingText(`AI Processing: ${Math.round((current / total) * 100)}%`);
                }
            });
                        ...
                        <div className="space-y-6 text-center w-full">
                            <div className="border-2 border-dashed border-muted-foreground/25 rounded-xl p-8 bg-muted/5">
                                ...
                                <p className="text-sm text-muted-foreground mb-6">
                                    Take a photo of your product. AI will automatically remove the background and add a studio white backdrop.
                                </p>
