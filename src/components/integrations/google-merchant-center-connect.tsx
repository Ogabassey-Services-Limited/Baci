  ...
  const handleSync = async () => {
    ...
    try {
      ...
      toast({
        title: 'Sync Started',
        description:
          'Product feed is being updated and pushed to Google Merchant Center.',
      });
    } catch {
      toast({
        title: 'Sync Failed',
      ...
      <CardHeader className="pb-4">
        <div className="flex items-start justify-between">
          ...
          {isConnected ? (
            ...
            <Badge
              variant="outline"
              className="bg-gray-50 text-gray-600 border-gray-200 gap-1.5 py-1"
            >
        ...
        {isConnected ? (
          <div className="space-y-4">
            ...
            <div className="bg-muted/30 rounded-md p-3 text-xs text-muted-foreground flex gap-2 items-start border border-border/40">
              ...
              <p>
                Products with status <strong>Active</strong> and valid{' '}
                <strong>GTIN/MPN</strong> will be automatically synced. Ensure
                your shipping settings in Google Merchant Center match your
                store settings.
              </p>
            </div>
          </div>
          ...
          <div className="bg-muted/20 rounded-lg p-4 text-sm text-muted-foreground border border-border/40">
            <p className="leading-relaxed">
              Connect your Google Merchant Center account to automatically list
              your products on Google Shopping, display free product listings,
              and run Performance Max campaigns.
            </p>
