...
interface CustomerAuthContextType {
  ...
  updateCustomer: (data: Partial<Customer>) => Promise<{ success: boolean; error?: string }>;
}
...
export function CustomerAuthProvider({ children, merchantSlug }: CustomerAuthProviderProps) {
