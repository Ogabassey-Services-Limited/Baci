...
- `SUPABASE_JUMIA_CREDENTIAL_KEY`: Dedicated server-only Supabase key for the restricted Jumia credential RPC; it must be configured separately from the generic worker service-role key.
