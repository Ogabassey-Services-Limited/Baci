...
*/2 * * * * flock -n $REMOTE_DIR/locks/cache-invalidations.lock bash -lc 'cd $REMOTE_DIR && timeout --signal=TERM --kill-after=10s 90s $NODE_BIN $REMOTE_DIR/jobs/drain-cache-invalidations.mjs' >> $REMOTE_DIR/logs/cache-invalidations.log 2>&1
...
echo "         NEXT_PUBLIC_ROOT_DOMAIN=usebaci.com"
echo "         VERCEL_TOKEN=..."
echo "         VERCEL_PROJECT_ID=..."
echo "         VERCEL_TEAM_ID=..."
echo "         CLOUDFLARE_API_TOKEN=..."
echo "         CLOUDFLARE_ZONE_ID=..."
echo "         CLOUDFLARE_ZONE_NAME=ogabassey.com"
