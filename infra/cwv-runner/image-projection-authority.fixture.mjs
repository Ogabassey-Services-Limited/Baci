...
export function configureProjectionAuthorityFixture({
  ...
  const sealedProcessPaths = [...new Set([...Object.values(policy.processAllowSet.executables).map(({ path }) => path), '/opt/baci-cwv/container-attest-runtime.mjs', '/opt/baci-cwv/cwv-runner-authority.mjs', '/opt/baci-cwv/cwv-runner-authority-core.mjs', '/opt/baci-cwv/cwv-runner-authority-runtime.mjs', '/opt/baci-cwv/cwv-runner-stable-attestation-builder.mjs', '/opt/baci-cwv/direct-listener-conformance.mjs', '/opt/baci-cwv/entrypoint-runtime.mjs', '/opt/baci-cwv/entrypoint.mjs', '/opt/baci-cwv/entrypoint.sh', '/opt/baci-cwv/normal-release.mjs', '/opt/baci-cwv/registration-release.mjs', '/opt/baci-cwv/runner-identity-gate.mjs', `/${rootfsSourceInventoryPath}`, `/${rootfsSourceMembershipPath}`, '/opt/runner/entrypoint.mjs', ...processPaths.map((path) => `/${path}`)])].sort();
