...
const helpers = [
  ...
  ...'install-bootstrap.mjs install-bootstrap-atomic-state-file.mjs install-bootstrap-capture-persistence.mjs install-bootstrap-installed.mjs install-bootstrap-plan-publication.mjs install-account-identity.sh'.split(
    ' '
  ),
