-- Migration: Update storefront order stock column + fix ambiguous column refs
-- Created: 2026-02-06
-- Updated: 2026-02-07
-- Description: Use products.stock_quantity for stock updates; qualify all
--   column references with table aliases to avoid PL/pgSQL RETURNS TABLE
--   variable conflicts (fixes "column reference id is ambiguous" error).
--   Also: treat NULL stock_quantity as infinite (unmanaged stock).
