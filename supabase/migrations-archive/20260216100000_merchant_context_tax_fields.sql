-- Add tax_identification_number and legal_entity_name to get_user_merchant_context RPC
-- These fields are needed for FIRS e-Invoice compliance on receipts and invoices
