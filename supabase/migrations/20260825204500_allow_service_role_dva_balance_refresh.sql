-- Checkout reservations run through the service-role client. Allow that
-- already-authorized path to refresh a reused alias while retaining staff
-- permission checks for authenticated callers.
