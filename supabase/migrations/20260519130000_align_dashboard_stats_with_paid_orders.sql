...
BEGIN
  IF auth.role() IS DISTINCT FROM 'service_role'
    AND NOT COALESCE(public.has_merchant_access(p_merchant_id), FALSE) THEN
  ...
  SELECT
    ...
    COUNT(DISTINCT NULLIF(o.customer_email, ''))
  INTO
    v_current_revenue,
...
REVOKE ALL ON FUNCTION "public"."get_sales_dashboard_stats"("p_merchant_id" "uuid")
  FROM PUBLIC, "anon";

GRANT EXECUTE ON FUNCTION "public"."get_sales_dashboard_stats"("p_merchant_id" "uuid")
