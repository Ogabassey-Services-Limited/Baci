-- Boundary C1 corrective migration: authorize before product state resolution and
-- serialize operation-id replays without exposing a unique-constraint error.
