-- Make exact merchant-invoice completion claims serialize on applied funds,
-- and retire reviewed balance conflicts from the gateway wedge sweep.
...
COMMENT ON FUNCTION public.complete_order_gateway_payment(
  ...
  'Serializes marked merchant-invoice exact claims on applied funds and retires reviewed balance conflicts.';
