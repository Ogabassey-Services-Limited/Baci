-- A managed row with NULL stock cannot safely be decremented. Fail closed
-- rather than allowing the nullable comparison and subtraction to return a
-- successful no-op.
...
BEGIN
  ...
  IF current_stock IS NULL THEN
    RETURN QUERY SELECT FALSE, NULL::integer, 'Insufficient stock'::text;
    RETURN;
  END IF;
