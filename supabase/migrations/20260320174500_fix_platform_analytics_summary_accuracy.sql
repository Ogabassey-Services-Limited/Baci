-- Fix platform analytics summary accuracy and view efficiency.
-- Active merchants should be counted distinctly across the full date range,
-- not by taking the peak single-day count. Also materialize platform settings
-- once per query in platform_revenue instead of repeated scalar subqueries.
