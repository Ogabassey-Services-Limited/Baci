-- Restrict Credit Direct audit-note preservation to signature-verified webhook
-- writes. The route supplies a transient marker that this trigger strips before
-- storage so later service-role maintenance cannot inherit its provenance.
