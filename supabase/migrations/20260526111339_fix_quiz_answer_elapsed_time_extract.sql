-- Repair the authoritative quiz answer RPC without rewriting the already
-- committed Phase 1b migration. The previous version schema-qualified
-- EXTRACT using special-form syntax; use the normal pg_catalog function call.
