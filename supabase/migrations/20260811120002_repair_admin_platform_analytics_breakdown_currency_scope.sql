-- Keep analytics order counts inclusive of every recorded currency while
-- retaining NGN-only money totals. The prior breakdown helper used its NGN
-- CTE for both, making valid non-NGN orders disappear from count charts.
  ...
  SELECT jsonb_build_object(
    'dailyGmv', COALESCE((
      SELECT jsonb_agg(jsonb_build_object(
        'date', d.sale_date, 'gmv', d.gmv, 'orders', d.orders, 'merchants', d.merchants
