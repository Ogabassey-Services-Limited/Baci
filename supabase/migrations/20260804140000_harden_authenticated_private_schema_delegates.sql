-- Follow-up hardening for authenticated public wrappers that delegate directly
-- to private functions. Keep this separate from the already-applied checkout
-- boundary migration so migration bytes remain append-only and replayable.
