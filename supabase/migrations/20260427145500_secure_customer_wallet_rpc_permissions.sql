-- Restrict customer wallet RPC execution and add ownership checks for direct customer redemption.
...
DO $$
BEGIN
  IF to_regprocedure('public.redeem_customer_wallet(uuid, uuid, numeric, text, uuid, text)') IS NOT NULL THEN
