-- Use the shared legacy/new stock fallback when calculating inventory forecasts.
-- Some products have stock_quantity=0 alongside a positive legacy stock value;
-- the dashboard must report the same effective stock as other product flows.
