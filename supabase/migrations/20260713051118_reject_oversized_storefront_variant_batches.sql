-- Reject oversized storefront variant batches explicitly. The preceding RPC
-- migration was already applied before review, so this remains append-only and
-- keeps the remote migration ledger consistent.
