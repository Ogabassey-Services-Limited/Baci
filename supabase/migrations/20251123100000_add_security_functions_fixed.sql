...
-- Date: 2025-11-23
-- Purpose: Add atomic stock updates and security functions. This replaces the previously failed migration.
...
AS $$
BEGIN
  -- Remove null bytes using REPLACE with CHR(0)
...
-- RATE LIMITING TABLE
-- =============================================
-- Note: This was part of the failed migration. We ensure it's created here.
