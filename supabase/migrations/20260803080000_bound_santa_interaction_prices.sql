-- Keep analytics RPC inputs within the numeric(12,2) range of the target
-- columns. Values outside that range would fail after consuming the request
-- budget, rolling back the limiter increment and allowing repeated retries.
