-- A manually completed order is terminal and must not be overwritten by a
-- later carrier poll, including a carrier terminal status.
...
BEGIN
  ...
  WHERE orders.id = NEW.order_id
    ...
    AND orders.shipping_status IS DISTINCT FROM 'completed'
    AND (
