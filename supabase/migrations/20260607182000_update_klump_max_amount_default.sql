-- Raise the Klump BNPL default maximum from NGN 500,000 to NGN 1,000,000.
-- Existing merchant rows are preserved because the stored value may be a
-- merchant-configured cap rather than the historical default.

ALTER TABLE public.merchant_feature_settings
  ALTER COLUMN klump_max_amount SET DEFAULT 1000000;
