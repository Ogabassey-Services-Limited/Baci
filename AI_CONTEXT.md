...
4. **UI components are pure presentation**
   ...
   - Only props, rendering, and basic interaction handlers
...
|-------|-------|----------|
| `fashion` | Fashion & Apparel | Clothing, accessories, fashion items |
| `electronics` | Electronics & Gadgets | Tech products, electronic devices |
| `home-goods` | Home Goods & Decor | Furniture, home accessories |
| `health-beauty` | Health & Beauty | Cosmetics, wellness products |
| `handmade` | Handmade & Crafts | Artisan products, handcrafted items |
| `food-beverage` | Food & Beverage | Consumable goods, beverages |
| `other` | Other (custom) | User-defined business type |
...
│    ⚠️  Currently hardcoded to "Handmade & Crafts" at line 122   │
└─────────────────────────────────────────────────────────────────┘
```
...
2. [Optional] Click "Generate with AI" for description
   ├─ Calls: generateProductDescription(productName, "Handmade & Crafts", details)
   ├─ ⚠️  Business type is hardcoded at line 122
...
### 1. Business Type Not Passed to Product Descriptions
