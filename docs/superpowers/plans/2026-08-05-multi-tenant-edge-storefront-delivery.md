...
- [x] Make `docs/superpowers/evidence/storefront-edge/task-1a-inventory.json` the only Task 0A inventory input. The schema-v5 artifact is bound to reviewed source `0e96850c4d7d58bf95a9302d7b09a27fda39a720`, externally reviewed synthetic candidate `baci-edge-pilot.usebaci.com`, the strict normalized PostHog relay path `/baci-relay`, and inventory SHA-256 `86119e4a918675f38f0b2ec248752eb68b2f6b224da2e39f97ae5700c77221d7`; it contains no credentials, customer traffic, timestamps, or mutable PR state.
