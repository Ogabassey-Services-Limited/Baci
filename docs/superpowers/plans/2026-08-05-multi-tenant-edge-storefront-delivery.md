...
- [x] Make `docs/superpowers/evidence/storefront-edge/task-1a-inventory.json` the only Task 0A inventory input. The 2026-08-08 schema-v2 artifact is bound to `origin/main@20aa5c3652e87190c18ca023b31030f61aa8d580`, externally reviewed synthetic candidate `baci-edge-pilot.usebaci.com`, and inventory SHA-256 `63484cbbc7dc227a325e19708cd01c56ef0dc81642b2695dda9aa1c163f7ee31`; it contains no credentials, customer traffic, timestamps, or mutable PR state.
