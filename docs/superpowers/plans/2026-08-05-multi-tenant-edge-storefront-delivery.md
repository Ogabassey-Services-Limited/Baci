...
- [x] Make `docs/superpowers/evidence/storefront-edge/task-1a-inventory.json` the only Task 0A inventory input. The schema-v5 artifact is bound to reviewed source `13e870ba02c555a11a92d9498ec628aee118b3a9`, externally reviewed synthetic candidate `baci-edge-pilot.usebaci.com`, the strict normalized PostHog relay path `/baci-relay`, and inventory SHA-256 `73f1adbdcaa11cff4fffb2c0df0697dade03772e7b9ae3b52b7353a392f7d4ef`; it contains no credentials, customer traffic, timestamps, or mutable PR state.
