...
- [x] Make `docs/superpowers/evidence/storefront-edge/task-1a-inventory.json` the only Task 0A inventory input. The schema-v6 artifact is bound to reviewed source `5b62219815017afe2149cc56c7cf755473e57a3e`, externally reviewed synthetic candidate `baci-edge-pilot.usebaci.com`, the strict normalized PostHog relay path `/baci-relay`, and inventory SHA-256 `6d213d0ee1a9c703f6671debeeb098ccaa59cebcde650b4578ea32e6f133321a`; it contains no credentials, customer traffic, timestamps, or mutable PR state.
