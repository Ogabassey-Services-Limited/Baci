...
> **Status:** Revision 13, upgraded on 2026-08-08 against `origin/main@3e8da4ade554ac4c4b1cfea6866ac678796f5559`. Execute each task as a separately reviewed PR unless a task explicitly says it is an operational evidence step. This plan does not authorize production mutations, Cloudflare provisioning, a `proxy.ts` change, or a new privileged database boundary by itself.
