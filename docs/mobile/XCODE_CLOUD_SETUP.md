...
The repo currently includes an app-local wrapper script at:

- `apps/mobile-admin/ios/ci_scripts/ci_post_clone.sh`

For storefront, use the repo-root script (`ci_scripts/ci_post_clone.sh`) and scheme-based routing.
